...
import { F as r, Q as i, X as a, Z as o, pt as s } from "./index-D6kauhrE.js";
import { t as c } from "./shared-C_Bbs4jz.js";
var l = e(t()),
  u = n(),
  d = () => {
    let [e, t] = s(),
      ...
      C = () => {
        (t(new URLSearchParams()), (window.location.href = `/view-jobs`));
      };
    return (
      (0, l.useEffect)(() => {
        S();
      ...
      h
        ? (0, u.jsx)(`div`, {
            className: `min-h-[80vh] bg-slate-50 py-10 flex justify-center items-center`,
        ...
        : !n || n.length === 0
          ? (0, u.jsx)(`div`, {
              className: `min-h-[80vh] bg-slate-50 py-10`,
                  ...
                  (0, u.jsxs)(`div`, {
                    ...
                    children: [
                      (0, u.jsxs)(`h3`, {
                        ...
                        children: [`Results — `, m, ` jobs found`],
                      }),
                      (0, u.jsxs)(`p`, {
                        className: `text-xs text-slate-400`,
                        children: [`Showing `, n.length, ` of `, m],
                      }),
                    ],
                  }),
                  (0, u.jsx)(`div`, {
                    className: `grid grid-cols-1 gap-4`,
                    children: (0, u.jsx)(c, { data: n }),
                  }),
                  f &&
                    (0, u.jsx)(`div`, {
                      ...
                      children: (0, u.jsx)(`button`, {
                        ...
                        disabled: b,
                        className: `px-8 py-3 rounded-lg font-medium text-sm transition-colors ${b ? `bg-slate-200 text-slate-400 cursor-not-allowed` : `bg-white border-2 border-[#2563EB] text-[#2563EB] hover:bg-blue-50`}`,
                        children: b ? `Loading...` : `Load More Jobs`,
                      }),
                    }),
                ],
              }),
