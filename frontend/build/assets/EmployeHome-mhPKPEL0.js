...
import { a as u, i as d, r as f } from "./ViewJob-Dh8HVN8L.js";
import { n as p, t as m } from "./shared-C_Bbs4jz.js";
var h = e(t()),
  g = n(),
  _ = ({ data: e }) => {
    let t = JSON.parse(sessionStorage.getItem(`data`)),
      { getAllApplications: n } = a(),
      { getEmployeeProfile: r } = o(),
      [i, s] = (0, h.useState)([]),
      [d, f] = (0, h.useState)([]),
      m = async () => {
        try {
          let e = await r(t?.email);
          (f(e?.data?.data), s(e?.data?.data?.interests?.location));
        } catch (e) {
    ...
    return (
      ...
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsxs)(`div`, {
            ...
            children: [
              (0, g.jsxs)(`h4`, {
                ...
                children: [
                  (0, g.jsx)(`span`, {
                    children: `Jobs according to your preffered locations`,
                  }),
                  (0, g.jsx)(c, { className: ``, children: `see more` }),
                ],
              }),
              (0, g.jsx)(`p`, {
          ...
          (0, g.jsx)(l, {
            children: i?.map((t, n) => (0, g.jsx)(p, { data: u(e, t) })),
          }),
        ],
      })
    );
  ...
  v = () => {
    let e = JSON.parse(sessionStorage.getItem(`data`)),
      { searchResult: t } = s(),
      { getAllSections: n } = i(),
      { getEmployeeProfile: a } = o(),
      [l, u] = (0, h.useState)([]),
      [p, v] = (0, h.useState)(null),
      [y, b] = (0, h.useState)([]),
      [x, S] = (0, h.useState)(!0);
    (0, h.useRef)(null);
    let C = async () => {
        try {
          let t = await a(e?.email);
          v(t?.data?.data);
        } catch (e) {
          console.error(`Error fetching user profile:`, e);
        } finally {
      ...
      w = async () => {
        try {
          let e = await n();
          (e && e?.data.length > 0 && u(e?.data), S(!1));
        } catch (e) {
          console.error(e);
        }
      },
      T = async () => {
        try {
          let e = p?.interests?.category;
          if (e && e.length > 0) {
            let t = [];
            return (
              e.forEach((e) => {
                let n = l.find((t) => t.title === e);
                n && t.push(n._id);
              }),
              b(t),
              t
          ...
          console.error(`Error filtering categories by name:`, e);
        }
      };
    return (
      (0, h.useEffect)(() => {
                  ...
                  children: (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, g.jsx)(`p`, {
                        ...
                        children: `Increase your chance to get call from recruiters with Career Techguru`,
                      }),
                    ],
                  }),
                }),
              ...
              (0, g.jsx)(`div`, {
                ...
                children: (0, g.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, g.jsx)(r, { categories: l }),
                  ],
                }),
              }),
              (0, g.jsx)(`p`, { className: `hr bg-secondary my-3` }),
              (0, g.jsxs)(`div`, {
                className: `row`,
                children: [
                  (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, g.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          y.map((e, n) => (0, g.jsx)(m, { data: f(t, e) })),
                        ],
                      }),
                      (0, g.jsx)(`div`, {
                        className: `row my-4 rounded bg-dark`,
                        children: (0, g.jsx)(_, { data: t }),
                      }),
                    ],
                  }),
                  (0, g.jsx)(`div`, {
