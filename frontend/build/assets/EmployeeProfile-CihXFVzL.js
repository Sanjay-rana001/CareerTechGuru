...
import { n as S } from "./DateFilter-GHWGxUbN.js";
import { t as C } from "./UpdateInput-CKrIjRX2.js";
import { t as w } from "./vsc-BoyV5Cs0.js";
var T = r((e) => {
    Object.defineProperty(e, "__esModule", { value: !0 });
    var t,
      r = n(),
      i = (t = r) && typeof t == `object` && `default` in t ? t.default : t;
    function a(e, t) {
    ...
    var l = (function (e) {
      ...
      function r(t) {
        ...
        return (
          ...
          (n.onChange = n.onChange.bind(o(n))),
          (n.onKeyPress = n.onKeyPress.bind(o(n))),
          (n.onFocus = n.onFocus.bind(o(n))),
          (n.onBlur = n.onBlur.bind(o(n))),
          (n.renderMultiselectContainer = n.renderMultiselectContainer.bind(
            o(n),
          )),
          (n.renderSelectedList = n.renderSelectedList.bind(o(n))),
          (n.onRemoveSelectedItem = n.onRemoveSelectedItem.bind(o(n))),
          (n.toggelOptionList = n.toggelOptionList.bind(o(n))),
          (n.onArrowKeyNavigation = n.onArrowKeyNavigation.bind(o(n))),
          (n.onSelectItem = n.onSelectItem.bind(o(n))),
          (n.filterOptionsByInput = n.filterOptionsByInput.bind(o(n))),
          (n.removeSelectedValuesFromOptions =
            n.removeSelectedValuesFromOptions.bind(o(n))),
          (n.isSelectedValue = n.isSelectedValue.bind(o(n))),
          (n.fadeOutSelection = n.fadeOutSelection.bind(o(n))),
          (n.isDisablePreSelectedValues = n.isDisablePreSelectedValues.bind(
            o(n),
          )),
          (n.renderGroupByOptions = n.renderGroupByOptions.bind(o(n))),
          (n.renderNormalOption = n.renderNormalOption.bind(o(n))),
          (n.listenerCallback = n.listenerCallback.bind(o(n))),
          (n.resetSelectedValues = n.resetSelectedValues.bind(o(n))),
          (n.getSelectedItems = n.getSelectedItems.bind(o(n))),
          (n.getSelectedItemsCount = n.getSelectedItemsCount.bind(o(n))),
          (n.hideOnClickOutside = n.hideOnClickOutside.bind(o(n))),
          (n.onCloseOptionList = n.onCloseOptionList.bind(o(n))),
          (n.isVisible = n.isVisible.bind(o(n))),
          n
        );
      }
      ((n = e),
      ...
      return (
        ...
        (l.resetSelectedValues = function () {
          var e = this,
        ...
        (l.getSelectedItems = function () {
          return this.state.selectedValues;
        }),
        (l.getSelectedItemsCount = function () {
        ...
        (l.componentDidUpdate = function (e) {
          ...
          (JSON.stringify(e.options) !== JSON.stringify(n) &&
            ...
            JSON.stringify(i) !== JSON.stringify(r) &&
              this.setState(
                {
                  selectedValues: Object.assign([], r),
                  preSelectedValues: Object.assign([], r),
                },
                this.initialSetValue,
              ));
        }),
        (l.listenerCallback = function () {
        ...
        (l.removeSelectedValuesFromOptions = function (e) {
          var t = this.props,
            n = t.isObject,
            r = t.displayValue,
            i = t.groupBy,
            ...
            o = a.selectedValues,
            s = o === void 0 ? [] : o,
            c = a.unfilteredOptions;
          if ((!e && i && this.groupByOptions(a.options), s.length || e)) {
            if (n) {
              ...
              (i && this.groupByOptions(l),
                this.setState(
                  { options: l, filteredOptions: l },
        ...
        (l.filterOptionsByInput = function () {
          var e,
            t = this,
            n = this.state,
            r = n.inputValue,
          ...
          ((e = n.filteredOptions.filter(
            i.isObject
              ? function (e) {
                  return t.matchValues(e[a], r);
                }
              : function (e) {
                  return t.matchValues(e, r);
                },
          )),
            this.groupByOptions(e),
            this.setState({ options: e }));
        }),
        (l.matchValues = function (e, t) {
        ...
        (l.onArrowKeyNavigation = function (e) {
          var t = this.state,
            n = t.options,
            r = t.highlightOption,
          ...
          if (
            (e.keyCode !== 8 ||
              ...
              !a.length ||
              this.onRemoveSelectedItem(a.length - 1),
            n.length)
          ) {
            if (e.keyCode === 38)
              this.setState(
            ...
            else if (e.key === `Enter` && n.length && i) {
              if (r === -1) return;
              this.onSelectItem(n[r]);
            }
          }
        }),
        (l.onRemoveSelectedItem = function (e) {
          var t,
            n = this,
            r = this.state.selectedValues,
            i = this.props,
            a = i.onRemove,
            o = i.showCheckbox,
            s = i.displayValue;
          ((t = i.isObject
            ...
            r.splice(t, 1),
            a(r, e),
            this.setState({ selectedValues: r }, function () {
              o || n.removeSelectedValuesFromOptions(!0);
            }),
            this.props.closeOnSelect || this.searchBox.current.focus());
        }),
        (l.onSelectItem = function (e) {
          var t = this,
            ...
            s = r.showCheckbox;
          if (
            (this.state.keepSearchTerm || this.setState({ inputValue: `` }), o)
          )
            return (this.onSingleSelect(e), void a([e], e));
        ...
        (l.onSingleSelect = function (e) {
          this.setState({ selectedValues: [e], toggleOptionsList: !1 });
        }),
        (l.isSelectedValue = function (e) {
          var t = this.props,
            n = t.displayValue,
            r = this.state.selectedValues;
          return t.isObject
        ...
        (l.renderOptionList = function () {
          var e = this.props,
            t = e.groupBy,
            n = e.style,
            r = e.emptyRecordMsg,
            a = e.loadingMessage,
            o = a === void 0 ? `loading...` : a,
        ...
        (l.renderGroupByOptions = function () {
          var e = this,
            t = this.props,
            n = t.isObject,
            r = n !== void 0 && n,
          ...
          return Object.keys(l).map(function (t) {
            return i.createElement(
              ...
              i.createElement(
                `li`,
                { className: `groupHeading`, style: s.groupHeading },
                t,
              ),
              l[t].map(function (t, n) {
                var l = e.isSelectedValue(t);
                return i.createElement(
                  `li`,
                  {
                    key: `option` + n,
        ...
        (l.renderNormalOption = function () {
          ...
          return this.state.options.map(function (t, n) {
            ...
            return i.createElement(
              ...
              e.props.optionValueDecorator(r ? t[a] : (t || ``).toString(), t),
            );
          });
        }),
        (l.renderSelectedList = function () {
          var e = this,
            t = this.props,
            n = t.isObject,
            r = n !== void 0 && n,
            ...
            l = this.state,
            u = l.closeIconType;
          return l.selectedValues.map(function (t, n) {
            return i.createElement(
              `span`,
              {
                className:
        ...
        (l.isDisablePreSelectedValues = function (e) {
          var t = this.props,
            n = t.displayValue,
            r = this.state.preSelectedValues;
          return (
            !(!t.disablePreSelectedValues || !r.length) &&
            (t.isObject
              ? r.filter(function (t) {
                  return t[n] === e[n];
                }).length > 0
        ...
        (l.fadeOutSelection = function (e) {
          var t = this.props,
            n = t.selectionLimit;
          if (!t.singleSelect) {
            var r = this.state.selectedValues;
            return (
              n != -1 &&
              n == r.length &&
              (n == r.length
        ...
        (l.toggelOptionList = function () {
          this.setState({
            toggleOptionsList: !this.state.toggleOptionsList,
            highlightOption: this.props.avoidHighlightFirstOption ? -1 : 0,
          });
        }),
        (l.onCloseOptionList = function () {
          this.setState({
            toggleOptionsList: !1,
            highlightOption: this.props.avoidHighlightFirstOption ? -1 : 0,
            inputValue: ``,
        ...
        (l.renderMultiselectContainer = function () {
          var e = this.state,
            t = e.inputValue,
          ...
          return i.createElement(
            `div`,
            {
              ...
              style: s.multiselectContainer,
            },
            i.createElement(
              `div`,
              {
                className:
                  `search-wrapper searchWrapper ` + (c ? `singleSelect` : ``),
              ...
              i.createElement(`input`, {
                type: `text`,
                ref: this.searchBox,
                className: `searchBox ` + (c && r.length ? `display-none` : ``),
                id: (l || `search`) + `_input`,
                ...
                onBlur: this.onBlur,
                placeholder: (c && r.length) || (d && r.length) ? `` : o,
              ...
              (c || p) &&
                i.createElement(
                  ...
                  null,
                  m
                    ? i.createElement(`span`, { className: `icon_down_dir` }, m)
                    : i.createElement(`img`, {
            ...
            i.createElement(
              ...
              {
                className:
                  `optionListContainer ` + (n ? `displayBlock` : `displayNone`),
...
var A = i(),
  ...
  N = () => {
    let { createUserProfile: e, updateEmployeeDetails: t } = u(),
      { getAllSections: n } = c(),
      [r, i] = (0, D.useState)([]),
      [a, o] = (0, D.useState)(!1),
      s = JSON.parse(sessionStorage.getItem(`data`)),
      [l, f] = (0, D.useState)({
        ...
        interests: { category: [], location: [], jobType: [] },
      }),
      p = g(),
      [h, y] = (0, D.useState)(``),
      [b, x] = (0, D.useState)(``),
      ...
      T = (e) => {
        ...
        f(
          o
            ? (e) => ({ ...e, [a]: { ...e[a], [o]: r === `checkbox` ? i : n } })
            : (e) => ({ ...e, [t]: r === `checkbox` ? i : n }),
        );
      },
      E = (e, t) => {
        let { name: n, value: r, type: i, checked: a } = t.target,
          o = l.experiences.map((t, o) =>
            o === e ? { ...t, [n]: i === `checkbox` ? a : r } : t,
          );
        f((e) => ({ ...e, experiences: o }));
      },
      k = (e, t) => {
        let { name: n, value: r, type: i, checked: a } = t.target,
          o = l.education.map((t, o) =>
            o === e ? { ...t, [n]: i === `checkbox` ? a : r } : t,
          );
        f((e) => ({ ...e, education: o }));
      },
    ...
    let I = (e, t, n) => {
        (n === `category` && e.length > 5) ||
          f((t) => ({
            ...t,
            interests: { ...t.interests, [n]: e.map((e) => e.title) },
          }));
      },
      L = (e, t, n) => {
        f((t) => ({
        ...
        children: [
          ...
          (0, A.jsxs)(`form`, {
            onSubmit: async (n) => {
              ...
              try {
                if (!S)
                  (await e(l)) && (x(`Profile uploaded successfully.`), p(`/`));
                else {
                  let n = await e(l);
                  if (n) {
                    console.log(`User profile created successfully`, n);
                    let e = await v(
                      (await d(m(_, `resumes/${l.email}/${S.name}`), S)).ref,
                    );
                    (await t(l.email, { resumeUrl: e }),
                      console.log(`Profile updated with resume URL`, e),
                      x(`Profile and resume uploaded successfully.`),
                      p(`/`));
                  }
                }
              } catch (e) {
                (console.error(`Error uploading profile/resume:`, e),
                  y(`Error in setting up the request: ` + e.message));
              }
            },
            className: `space-y-6`,
            children: [
                ...
                children: [
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, A.jsx)(O.Multiselect, {
                        options: r,
                        selectedValues: r.filter((e) =>
                          l.interests.category.includes(e.title),
                        ),
                        onSelect: (e, t) => I(e, t, `category`),
                        onRemove: (e, t) => L(e, t, `category`),
                        displayValue: `title`,
                        loading: a,
                        disablePreSelectedValues: !0,
                        style: {
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, A.jsx)(O.Multiselect, {
                        options: M,
                        selectedValues: M.filter((e) =>
                          l.interests.location.includes(e.title),
                        ),
                        onSelect: (e, t) => I(e, t, `location`),
                        onRemove: (e, t) => L(e, t, `location`),
                        displayValue: `title`,
                        loading: a,
                        style: {
                          chips: { background: `#2563EB`, fontSize: `12px` },
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, A.jsx)(O.Multiselect, {
                        options: j,
                        selectedValues: j.filter((e) =>
                          l.interests.jobType.includes(e.title),
                        ),
                        onSelect: (e, t) => I(e, t, `jobType`),
                        onRemove: (e, t) => L(e, t, `jobType`),
                        displayValue: `title`,
                        loading: a,
                        style: {
                          chips: { background: `#2563EB`, fontSize: `12px` },
...
function P(e) {
  return x({
    ...
    child: [
      ...
      { tag: `path`, attr: { d: `M2 10l1 4l1.5 -4l1.5 4l1 -4` }, child: [] },
      { tag: `path`, attr: { d: `M17 10l1 4l1.5 -4l1.5 4l1 -4` }, child: [] },
      { tag: `path`, attr: { d: `M9.5 10l1 4l1.5 -4l1.5 4l1 -4` }, child: [] },
    ],
  })(e);
}
var F = ({ data: e }) => {
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, A.jsxs)(`p`, {
                        ...
                        children: [
                          (0, A.jsx)(`span`, { children: e?.email }),
                          (0, A.jsx)(`span`, {
                            className: `text-slate-300`,
                            children: `|`,
                          }),
                          (0, A.jsx)(`span`, { children: e?.mobile }),
                          e?.experienceInYear > 0 &&
                            (0, A.jsxs)(A.Fragment, {
                              children: [
                                (0, A.jsx)(`span`, {
                                  className: `text-slate-300`,
              ...
              children: [
                e?.experiences &&
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, A.jsx)(`div`, {
                        className: `space-y-6`,
                        children: e.experiences.map((e, t) =>
                          (0, A.jsxs)(
                            `div`,
                            {
                              ...
                              children: [
                                ...
                                (0, A.jsxs)(`div`, {
                                  ...
                                  children: [
                                    S(e?.startDate),
                                    ` — `,
                                    e?.isActive ? `Present` : S(e?.endDate),
                                  ],
                                }),
                              ],
                            },
                ...
                (0, A.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, A.jsxs)(`form`, {
                      onSubmit: async (t) => {
                        if ((t.preventDefault(), g(``), T(``), !E)) {
                          g(`Please select a file to upload.`);
                          return;
                        }
                        try {
                          let t = p.currentUser,
                            n = e?.email || (t ? t.email : null);
                          if (!n) {
                            g(`User email not found. Please log in again.`);
                            return;
                          }
                          let r = await v(
                            (await d(m(_, `resumes/${n}/${E.name}`), E)).ref,
                          );
                          (await y(
                            h(b, `profiles`, n),
                            { resumeUrl: r },
                          ...
                          (console.error(`Error uploading resume:`, e),
                            g(`Error in setting up the request: ` + e.message));
                        }
                      },
                      className: `space-y-4`,
                      children: [
        ...
        t &&
          (0, A.jsx)(o, {
            ...
            children: (0, A.jsx)(C, {
              ...
              field: r,
              onUpdate: (e) => {
                (console.log(`Updated ${e.key}: ${e.value}`),
                  n(!1),
                  window.location.reload());
              },
            }),
  ...
  L = () => {
    let e = JSON.parse(sessionStorage.getItem(`data`)),
      { getEmployeeProfile: t } = u(),
      [n, r] = (0, D.useState)(null),
      [i, a] = (0, D.useState)(!0),
      o = async () => {
        try {
          let n = await t(e?.email);
          r(n?.data?.data);
        } catch (e) {
    ...
    return (
      ...
      i
        ? (0, A.jsx)(f, {})
        : (0, A.jsx)(`div`, {
            children: n ? (0, A.jsx)(F, { data: n }) : (0, A.jsx)(N, {}),
          })
    );
  };
