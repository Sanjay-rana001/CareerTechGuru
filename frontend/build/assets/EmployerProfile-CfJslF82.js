...
import { t as u } from "./esm-D4W-GGgw.js";
import { n as d, t as f } from "./esm-Dvl3qeZn.js";
import { t as p } from "./UpdateInput-CKrIjRX2.js";
var m = e(n()),
  h = e(d()),
  g = r(),
  _ = ({
        ...
        children: (0, g.jsxs)(`div`, {
          ...
          children: [
            (0, g.jsx)(`h4`, {
              ...
              children: `Add company basic details`,
            }),
            (0, g.jsx)(`div`, {
              className: `row py-3`,
              children: (0, g.jsxs)(`form`, {
                ...
                children: [
                  ...
                  (0, g.jsxs)(`div`, {
                    className: `form-group mb-3 h-[40vh]`,
                    children: [
                      (0, g.jsxs)(`label`, {
                        htmlFor: `description`,
                        className: `form-label`,
  ...
  y = () => {
    let [e, t] = (0, m.useState)(!1),
      [n, r] = (0, m.useState)(``),
      [u, d] = (0, m.useState)(``),
      { getAdminsDetailsByAdminId: f } = l(),
      [h, v] = (0, m.useState)([]),
      y = JSON.parse(sessionStorage.getItem(`data`)),
      [b, x] = (0, m.useState)(!0),
      S = async () => {
        try {
          let e = await f(y?.id, `Employer`);
          (e && v(e), x(!1));
        } catch (e) {
          (console.error(e), x(!1));
        }
