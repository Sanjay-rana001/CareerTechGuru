...
import { J as i, mt as a } from "./index-D6kauhrE.js";
import { t as o } from "./build-0CSi1ee1.js";
var s = t({ default: () => d }),
  c = e(n()),
  l = e(o()),
  u = r(),
  d = ({ handleBackToLogin: e }) => {
    let {
        forgotPassword: t,
        verifyOtpForPasswordReset: n,
        resetPassword: r,
      } = i(),
      [o, s] = (0, c.useState)(``),
      [d, f] = (0, c.useState)(``),
