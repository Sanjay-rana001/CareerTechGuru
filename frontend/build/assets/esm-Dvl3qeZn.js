import { a as e, n as t, r as n } from "./jsx-runtime-CjtlecKO.js";
import { K as r, gt as i } from "./index-D6kauhrE.js";
var a = n((e, t) => {
    function n() {
  ...
  me = n((e, t) => {
    ...
    function T(e, t, n, o, y, C, T) {
      switch (n) {
        ...
        case _:
          var D = o & l;
          if (((E ||= c), e.size != t.size && !D)) return !1;
          var O = T.get(e);
          if (O) return O == t;
          ((o |= u), T.set(e, t));
          var k = a(E(e), E(t), o, y, C, T);
          return (T.delete(e), k);
        case b:
  ...
  Ee = n((e, t) => {
    var n = S(),
      ...
      A = {};
    ((A[b] = A[x] = A[C] = A[w] = A[T] = A[E] = A[D] = A[O] = A[k] = !0),
      (A[a] =
        A[o] =
        A[v] =
        A[s] =
  ...
  Ne = n((e, t) => {
    t.exports = Me()(Object.keys, Object);
  }),
  Pe = n((e, t) => {
    var n = je(),
      r = Ne(),
  ...
  ze = n((e, t) => {
    t.exports = A()(v(), `DataView`);
  }),
  Be = n((e, t) => {
    t.exports = A()(v(), `Promise`);
  }),
  Ve = n((e, t) => {
    t.exports = A()(v(), `Set`);
  }),
  He = n((e, t) => {
    t.exports = A()(v(), `WeakMap`);
  }),
  Ue = n((e, t) => {
    var n = ze(),
      r = j(),
    ...
    (function (n, r) {
      ...
      return (function (e) {
        ...
        function (e, t, n) {
          ...
          function u(e, t) {
            var n = f(e);
            if (n == null) throw new i(`Unable to create ` + e + ` blot`);
            var r = n;
            return new r(
          ...
          function f(e, t) {
            t === void 0 && (t = l.ANY);
            var n;
            if (typeof e == `string`) n = c[e] || a[e];
            else if (e instanceof Text || e.nodeType === Node.TEXT_NODE)
              n = c.text;
            else if (typeof e == `number`)
              e & l.LEVEL & l.BLOCK
                ? (n = c.block)
                : e & l.LEVEL & l.INLINE && (n = c.inline);
            else if (e instanceof HTMLElement) {
              var r = (e.getAttribute(`class`) || ``).split(/\s+/);
              for (var i in r) if (((n = o[r[i]]), n)) break;
              n ||= s[e.tagName];
            }
            return n == null
              ? null
              : t & l.LEVEL & n.scope && t & l.TYPE & n.scope
                ? n
                : null;
          }
          t.query = f;
          function p() {
            ...
            var t = e[0];
            if (typeof t.blotName != `string` && typeof t.attrName != `string`)
              throw new i(`Invalid definition`);
            if (t.blotName === `abstract`)
              throw new i(`Cannot register abstract class`);
            return (
              (c[t.blotName || t.attrName] = t),
              typeof t.keyName == `string`
                ? (a[t.keyName] = t)
                : (t.className != null && (o[t.className] = t),
                  t.tagName != null &&
                    (Array.isArray(t.tagName)
                      ? (t.tagName = t.tagName.map(function (e) {
                    ...
                    (Array.isArray(t.tagName)
                      ...
                      (s[e] == null || t.className == null) && (s[e] = t);
                    }))),
              t
            );
          }
          ...
          ((c.prototype.insert = function (e, t) {
            ...
            (c.prototype.push = function (e) {
              var t = this.ops.length,
                n = this.ops[t - 1];
              if (((e = a(!0, {}, e)), typeof n == `object`)) {
                if (typeof e.delete == `number` && typeof n.delete == `number`)
                  return (
                    (this.ops[t - 1] = { delete: n.delete + e.delete }),
                    this
                  );
                if (
                  typeof n.delete == `number` &&
                  e.insert != null &&
                  (--t, (n = this.ops[t - 1]), typeof n != `object`)
                )
            ...
            (c.prototype.slice = function (e, t) {
              ((e ||= 0), typeof t != `number` && (t = 1 / 0));
              for (
                var n = [], r = o.iterator(this.ops), i = 0;
                i < t && r.hasNext();
              ) {
                var a;
                (i < e ? (a = r.next(e - i)) : ((a = r.next(t - i)), n.push(a)),
                  (i += o.length(a)));
              }
              return new c(n);
            }),
            (c.prototype.compose = function (e) {
              ...
              if (
                ...
                for (
                  var s = a.retain;
                  t.peekType() === `insert` && t.peekLength() <= s;
                )
                  ((s -= t.peekLength()), r.push(t.next()));
                a.retain - s > 0 && n.next(a.retain - s);
              }
              for (var l = new c(r); t.hasNext() || n.hasNext();)
                if (n.peekType() === `insert`) l.push(n.next());
                else if (t.peekType() === `delete`) l.push(t.next());
                else {
                  ...
                  if (typeof f.retain == `number`) {
                    ...
                    if (
                      (m && (p.attributes = m),
                      l.push(p),
                      !n.hasNext() && i(l.ops[l.ops.length - 1], p))
                    ) {
                      var h = new c(t.rest());
            ...
            (c.prototype.concat = function (e) {
              ...
              return (
                e.ops.length > 0 &&
                  (t.push(e.ops[0]), (t.ops = t.ops.concat(e.ops.slice(1)))),
                t
              );
            }),
            (c.prototype.diff = function (e, t) {
              if (this.ops === e.ops) return new c();
              var n = [this, e].map(function (t) {
                  return t
                    .map(function (n) {
                      if (n.insert != null)
                        return typeof n.insert == `string` ? n.insert : s;
                      throw Error(
                        `diff() called ` +
                          (t === e ? `on` : `with`) +
                          ` non-document`,
              ...
              return (
                l.forEach(function (e) {
                  for (var t = e[1].length; t > 0;) {
                    ...
                    switch (e[0]) {
                      case r.INSERT:
                        ((n = Math.min(d.peekLength(), t)), a.push(d.next(n)));
                        break;
                      case r.DELETE:
                      ...
                      case r.EQUAL:
                        ...
                        i(s.insert, c.insert)
                          ? a.retain(
                              n,
                              o.attributes.diff(s.attributes, c.attributes),
                            )
                          : a.push(c).delete(n);
                        break;
                    }
...
`;
              for (
                var n = o.iterator(this.ops), r = new c(), i = 0;
                n.hasNext();
              ) {
                ...
                var a = n.peek(),
                  ...
                  l =
                    typeof a.insert == `string`
                      ? a.insert.indexOf(t, s) - s
                      : -1;
                if (l < 0) r.push(n.next());
                else if (l > 0) r.push(n.next(l));
                else {
                  if (e(r, n.next(1).attributes || {}, i) === !1) return;
                  ((i += 1), (r = new c()));
                }
              }
              r.length() > 0 && e(r, {}, i);
            ...
            (c.prototype.transform = function (e, t) {
              ...
              for (
                ...
                if (
                  ...
                  i.retain(o.length(n.next()));
                else if (r.peekType() === `insert`) i.push(r.next());
                else {
                  ...
                  l.delete
                    ...
                    : i.retain(
                        a,
                        o.attributes.transform(s.attributes, l.attributes, t),
                      );
                }
              return i.chop();
            }),
...
`)
                        ...
                        var a = s.default.create(_.blotName);
                        (this.parent.insertBefore(
                          a,
                          e === 0 ? this : this.next,
                        ),
                          a.insertAt(0, n.slice(0, -1)));
                      } else
                        i(
                          t.prototype.__proto__ ||
                            Object.getPrototypeOf(t.prototype),
                  ...
                  value: function (e, n, r, a) {
                    n <= 0 ||
                      (s.default.query(r, s.default.Scope.BLOCK)
                        ? e + n === this.length() && this.format(r, a)
                        : i(
                            t.prototype.__proto__ ||
                              Object.getPrototypeOf(t.prototype),
                            `formatAt`,
...
`),
                      ...
                      o.length > 0 &&
                        (e < this.length() - 1 || this.children.tail == null
                          ? i(
                              ...
                              `insertAt`,
                              this,
                            ).call(this, Math.min(e, this.length() - 1), o)
                ...
                },
                {
                  ...
                  value: function (e, n) {
                    ...
                    (i(
                      ...
                      r instanceof c.default && r.remove(),
                      (this.cache = {}));
                  },
                },
                {
          ...
          ((_.blotName = `block`),
            (_.tagName = `P`),
            (_.defaultChild = `break`),
            (_.allowedChildren = [l.default, s.default.Embed, u.default]));
          function v(e) {
            var t =
              arguments.length > 1 && arguments[1] !== void 0
                ? arguments[1]
            ...
            return e == null ||
              (typeof e.formats == `function` &&
                (t = (0, a.default)(t, e.formats())),
              e.parent == null ||
                e.parent.blotName == `scroll` ||
                e.parent.statics.scope !== e.statics.scope)
              ? t
              : v(e.parent, t);
          }
          ((t.bubbleFormats = v), (t.BlockEmbed = g), (t.default = _));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          var y = (0, m.default)(`quill`),
            b = (function () {
              a(e, null, [
                {
                  key: `debug`,
                  value: function (e) {
                    (e === !0 && (e = `log`), m.default.level(e));
                  },
                },
                {
                  key: `find`,
              ...
              function e(t) {
                ...
                if (
                  ...
                  return y.error(`Invalid Quill container`, t);
                ...
                (this.container.classList.add(`ql-container`),
                  ...
                  this.emitter.on(c.default.events.EDITOR_CHANGE, function (e) {
                    e === c.default.events.TEXT_CHANGE &&
                      ...
                      return S.call(
                        ...
                        function () {
                          ...
                          if (u.default.query(e, u.default.Scope.BLOCK))
                            ...
                            return (n.selection.format(e, t), i);
                          else
                    ...
                    value: function (e, t, n, r, a) {
                      ...
                      return (
                        ...
                        S.call(
                          this,
                          function () {
                            return o.editor.formatLine(e, t, s);
                          },
                          a,
                          e,
                          0,
                    ...
                    value: function (e, t, n, r, a) {
                      ...
                      return (
                        ...
                        S.call(
                          this,
                          function () {
                            return o.editor.formatText(e, t, s);
                          },
                          a,
                          e,
                          0,
                    ...
                    value: function (e, t, n, r, a) {
                      ...
                      return (
                        ...
                        S.call(
                          this,
                          function () {
                            return o.editor.insertText(e, t, s);
                          },
                          a,
                          e,
                          t.length,
...
` &&
          ...
          ((b.DEFAULTS = {
            ...
            (b.events = c.default.events),
            (b.sources = c.default.sources),
            (b.version = `1.3.7`),
            (b.imports = {
              delta: o.default,
              parchment: u.default,
              "core/module": l.default,
              "core/theme": h.default,
            }));
          function x(e, t) {
            if (
              ((t = (0, p.default)(
              ...
              !t.theme || t.theme === b.DEFAULTS.theme)
            )
              t.theme = h.default;
            else if (
              ((t.theme = b.import(`themes/` + t.theme)), t.theme == null)
            )
              throw Error(
            ...
            return (
              t.modules != null &&
                ...
                (t.modules.toolbar = { container: t.modules.toolbar }),
              (t = (0, p.default)(!0, {}, b.DEFAULTS, { modules: r }, n, t)),
          ...
          function S(e, t, n, r) {
            if (
              this.options.strict &&
              !this.isEnabled() &&
              t === c.default.sources.USER
            )
              return new o.default();
            var i = n == null ? null : this.getSelection(),
              a = this.editor.delta,
              s = e();
            if (
              (i != null &&
                (n === !0 && (n = i.index),
                r == null ? (i = w(i, s, t)) : r !== 0 && (i = w(i, n, r, t)),
                this.setSelection(i, c.default.sources.SILENT)),
              s.length() > 0)
            ) {
              var l,
                u = [c.default.events.TEXT_CHANGE, s, a, t];
              if (
                ((l = this.emitter).emit.apply(
                  l,
                  [c.default.events.EDITOR_CHANGE].concat(u),
                ),
                t !== c.default.sources.SILENT)
              ) {
                var d;
            ...
            return (
              typeof e.index == `number` && typeof e.length == `number`
                ? typeof t == `number`
                  ...
                  : ((a = i), (i = n), (n = t), (t = e.length), (e = e.index))
                : typeof t != `number` && ((a = i), (i = n), (n = t), (t = 0)),
              (n === void 0 ? `undefined` : r(n)) === `object`
                ? ((o = n), (a = i))
                : typeof n == `string` && (i == null ? (a = n) : (o[n] = i)),
              (a ||= c.default.sources.API),
              [e, t, o, a]
            );
          }
          function w(e, t, n, r) {
            ...
            if (t instanceof o.default) {
              var l = i(
                [e.index, e.index + e.length].map(function (e) {
              ...
              var u = i(
                [e.index, e.index + e.length].map(function (e) {
                  return e < t || (e === t && r === c.default.sources.USER)
                    ? e
                    : n >= 0
                      ? e + n
                      : Math.max(t, e + n);
            ...
            return new d.Range(a, s - a);
          }
          ((t.expandConfig = x), (t.overload = C), (t.default = b));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = (function () {
                ...
                [
                  {
                    ...
                    value: function (e, n, r, a) {
                      if (
                        ...
                        o.default.query(r, o.default.Scope.BLOT)
                      ) {
        ...
        function (e, t, n) {
          ...
          var d = (0, o.default)(`quill:events`);
          ...
          var f = (function (e) {
            ...
            function t() {
              ...
              return ((e.listeners = {}), e.on(`error`, d.error), e);
            }
            return (
              r(t, [
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (this.listeners[e.type] || []).forEach(function (n) {
                      var r = n.node,
                        i = n.handler;
                      (e.target === r || r.contains(e.target)) &&
                        i.apply(void 0, [e].concat(t));
                    });
                  },
                },
                {
          ...
          ((f.events = {
            ...
            (f.sources = { API: `api`, SILENT: `silent`, USER: `user` }),
            (t.default = f));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
        ...
        function (e, t, n) {
          ...
          function l(e, t, n) {
            ...
            if (a(e))
              return a(t) ? ((e = r.call(e)), (t = r.call(t)), o(e, t, n)) : !1;
            if (c(e)) {
              if (!c(t) || e.length !== t.length) return !1;
          ...
          t.default = (function () {
            ...
            return (
              ...
              (e.prototype.canAdd = function (e, t) {
                return r.query(e, r.Scope.BLOT & (this.scope | r.Scope.TYPE)) ==
                  null
                  ? !1
                  : this.whitelist == null
                    ? !0
        ...
        function (e, t, n) {
          ...
          ((h.blotName = `code`), (h.tagName = `CODE`));
          var g = (function (e) {
            m(t, e);
            function t() {
              return (
...
`,
                  ...
                  },
                  {
                    ...
                    value: function (e, n) {
                      if (!(e === this.statics.blotName && n)) {
                        var i = r(
                          this.descendant(u.default, this.length() - 1),
                          1,
                        )[0];
                  ...
                  },
                  {
                    ...
                    value: function (e, n, r, i) {
                      if (
                        n !== 0 &&
                        !(
                          s.default.query(r, s.default.Scope.BLOCK) == null ||
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      if (n == null) {
                        var i = r(this.descendant(u.default, e), 2),
                          a = i[0],
                          o = i[1];
                        a.insertAt(o, t);
                      }
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ...
                        return this.domNode.textContent.slice(0, e)
                          .lastIndexOf(`
`);
...
`,
                      ...
                      n != null &&
                        ...
                        (n.optimize(e), n.moveChildren(this), n.remove());
                    },
                  },
                  {
                    key: `replace`,
        ...
        function (e, t, n) {
          ...
          var b = /^[ -~]*$/,
            x = (function () {
              function e(t) {
                (y(this, e), (this.scroll = t), (this.delta = this.getDelta()));
              }
              return (
                a(e, [
                  {
...
`) &&
                              ...
                              var m = i(t.scroll.line(e), 2),
                                h = m[0],
                                _ = m[1],
                                v = (0, g.default)({}, (0, d.bubbleFormats)(h));
                              if (h instanceof f.default) {
                                var y = i(
                                  h.descendant(c.default.Leaf, _),
                                  1,
                                )[0];
                                v = (0, g.default)(v, (0, d.bubbleFormats)(y));
                              }
                              u = s.default.attributes.diff(v, u) || {};
                            } else if (r(o.insert) === `object`) {
                              var b = Object.keys(o.insert)[0];
                              if (b == null) return e;
                              t.scroll.insertAt(e, b, o.insert[b]);
                            }
                            a += l;
                          }
                          return (
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      return (
                        ...
                        this.update(new o.default().retain(e).delete(t))
                      );
                    },
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      return (
                        ...
                        Object.keys(r).forEach(function (i) {
                          if (!(
                            n.scroll.whitelist != null && !n.scroll.whitelist[i]
                          )) {
                            var a = n.scroll.lines(e, Math.max(t, 1)),
                              o = t;
                            a.forEach(function (t) {
                              var a = t.length();
                              if (!(t instanceof l.default)) t.format(i, r[i]);
                              else {
                                var s = e - t.offset(n.scroll),
                                  c = t.newlineIndex(s + o) - s + 1;
                                t.formatAt(s, c, i, r[i]);
                              }
                              o -= a;
                            });
                          }
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      t === 0
                        ? this.scroll.path(e).forEach(function (e) {
                            ...
                            t instanceof f.default
                              ? n.push(t)
                              : t instanceof c.default.Leaf && r.push(t);
                          })
                      ...
                      var a = [n, r].map(function (e) {
                        ...
                        for (
                          var t = (0, d.bubbleFormats)(e.shift());
                          Object.keys(t).length > 0;
                        ) {
                          var n = e.shift();
                          if (n == null) return t;
                          t = S((0, d.bubbleFormats)(n), t);
                        }
                        return t;
                      });
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      return (
                        ...
                        this.update(
                          new o.default().retain(e).insert(v({}, t, n)),
                        )
                      );
                    },
                  },
...
`,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return e.statics.blotName !== f.default.blotName ||
                        e.children.length > 1
                        ? !1
                        : e.children.head instanceof p.default;
                    },
                  },
                  {
                    key: `removeFormat`,
                      ...
                      a != null &&
                        ((c =
                          a instanceof l.default
                            ...
                            : a.length() - s),
                        (u = a.delta().slice(s, s + c - 1).insert(`
`)));
                      var d = this.getContents(e, t + c).diff(
                          new o.default().insert(n).concat(u),
                        ),
                        f = new o.default().retain(e).concat(d);
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        t[0].target.data.match(b) &&
                        c.default.find(t[0].target)
                      ) {
                        var i = c.default.find(t[0].target),
                          a = (0, d.bubbleFormats)(i),
                          s = i.offset(this.scroll),
                          l = t[0].oldValue.replace(u.default.CONTENTS, ``),
                          f = new o.default().insert(l),
                          p = new o.default().insert(i.value());
                        ((e = new o.default()
                          .retain(s)
                          .concat(f.diff(p, n))
                          .reduce(function (e, t) {
                        ...
                        ((this.delta = this.getDelta()),
                          (!e || !(0, h.default)(r.compose(e), this.delta)) &&
              ...
              return (
                e[r] == null ||
                  (t[r] === e[r]
                    ? (n[r] = t[r])
                    : Array.isArray(t[r])
                      ? t[r].indexOf(e[r]) < 0 && (n[r] = t[r].concat([e[r]]))
                      : (n[r] = [t[r], e[r]])),
                n
              );
            }, {});
          ...
          function C(e) {
            return e.reduce(function (e, t) {
              if (t.insert === 1) {
                ...
                return (
                  delete n.image,
                  e.insert({ image: t.attributes.image }, n)
                );
              }
              if (
                (t.attributes != null &&
                  (t.attributes.list === !0 || t.attributes.bullet === !0) &&
                  ((t = (0, m.default)(t)),
                  t.attributes.list
...
`,
        ...
        function (e, t, n) {
          ...
          var p = (0, l.default)(`quill:selection`),
            m = function e(t) {
              var n =
                arguments.length > 1 && arguments[1] !== void 0
                  ? arguments[1]
            ...
            h = (function () {
              function e(t, n) {
                ...
                (f(this, e),
                  ...
                  this.emitter.on(
                    c.default.events.SCROLL_BEFORE_UPDATE,
                    function () {
                      if (r.hasFocus()) {
                ...
                i(e, [
                    ...
                    value: function (e, t) {
                      if (!(
                        ...
                        if (!(
                          n == null ||
                          !n.native.collapsed ||
                          a.default.query(e, a.default.Scope.BLOCK)
                        )) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      var i = void 0,
                        a = r(this.scroll.leaf(e), 2),
                        o = a[0],
                        s = a[1];
                      if (o == null) return null;
                      var c = r(o.position(s, !0), 2);
                      ((i = c[0]), (s = c[1]));
                      var l = document.createRange();
                      if (t > 0) {
                        l.setStart(i, s);
                        var u = r(this.scroll.leaf(e + t), 2);
                        if (((o = u[0]), (s = u[1]), o == null)) return null;
                        var d = r(o.position(s, !0), 2);
                        return (
                          (i = d[0]),
                          (s = d[1]),
                          l.setEnd(i, s),
                        ...
                        return (
                          i instanceof Text
                            ? (s < i.data.length
                                ? (l.setStart(i, s), l.setEnd(i, s + 1))
                                : (l.setStart(i, s - 1),
                                  l.setEnd(i, s),
                                  (f = `right`)),
                              (p = l.getBoundingClientRect()))
                            : ((p = o.domNode.getBoundingClientRect()),
                              s > 0 && (f = `right`)),
                          {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      var i = n.map(function (e) {
                          ...
                          return o === 0
                            ? c
                            : s instanceof a.default.Container
                              ? c + s.length()
                              : c + s.index(i, o);
                        }),
                        o = Math.min(
                          Math.max.apply(Math, d(i)),
                          this.scroll.length() - 1,
                        ),
                        s = Math.min.apply(Math, [o].concat(d(i)));
                      return new m(s, o - s);
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        !g(this.root, e.startContainer) ||
                        (!e.collapsed && !g(this.root, e.endContainer))
                      )
                        return null;
                      var t = {
                        start: {
                    ...
                    value: function (e) {
                      ...
                      return (
                        n.forEach(function (e, n) {
                          e = Math.min(a - 1, e);
                          var o = void 0,
                            s = r(t.scroll.leaf(e), 2),
                            c = s[0],
                            l = s[1],
                            u = r(c.position(l, n !== 0), 2);
                          ((o = u[0]), (l = u[1]), i.push(o, l));
                        }),
                      ...
                      if (t != null) {
                        ...
                        if (n != null) {
                          var i = this.scroll.length() - 1,
                            a = r(this.scroll.line(Math.min(t.index, i)), 1)[0],
                            o = a;
                          if (
                            (t.length > 0 &&
                              (o = r(
                                this.scroll.line(
                                  Math.min(t.index + t.length, i),
                                ),
                                1,
                              )[0]),
                            !(a == null || o == null))
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        this.setNativeRange.apply(this, d(r).concat([t]));
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        !(0, s.default)(t, this.lastRange))
                      ) {
                        var l;
                        !this.composing &&
                          a != null &&
                          a.native.collapsed &&
                          a.start.node !== this.cursor.textNode &&
                          this.cursor.restore();
                        var u = [
                          c.default.events.SELECTION_CHANGE,
                          (0, o.default)(this.lastRange),
                          (0, o.default)(t),
                          e,
                        ];
                        if (
        ...
        function (e, t, n) {
          ...
          ((u.blotName = `break`), (u.tagName = `BR`), (t.default = u));
        },
        function (e, t, n) {
          var r =
            (this && this.__extends) ||
              ...
              return (
                ...
                (t.prototype.descendants = function (e, n, r) {
                  ...
                  var i = [],
                    a = r;
                  return (
                    this.children.forEachAt(n, r, function (n, r, o) {
                      (((e.blotName == null && e(n)) ||
                        (e.blotName != null && n instanceof e)) &&
                        i.push(n),
                        n instanceof t &&
                          (i = i.concat(n.descendants(e, r, a))),
                        (a -= o));
                    }),
                    i
                  );
                ...
                (t.prototype.insertAt = function (e, t, n) {
                  ...
                  if (i) i.insertAt(a, t, n);
                    ...
                    var s = n == null ? o.create(`text`, t) : o.create(t, n);
                    this.appendChild(s);
                  }
                }),
                ...
                (t.prototype.update = function (e, t) {
                  ...
                  (e.forEach(function (e) {
                    ...
                    r
                      ...
                      .forEach(function (e) {
                        var t = null;
                        e.nextSibling != null && (t = o.find(e.nextSibling));
                        var r = c(e);
                        (r.next != t || r.next == null) &&
                          (r.parent != null && r.parent.removeChild(n),
            ...
            return (
              ...
              (t.prototype.format = function (e, t) {
                ...
                n instanceof i.default
                  ...
                  : t &&
                    n != null &&
                    (e !== this.statics.blotName || this.formats()[e] !== t) &&
              ...
              (t.prototype.update = function (t, n) {
                ...
                (e.prototype.update.call(this, t, n),
                  t.some(function (e) {
                    return e.target === r.domNode && e.type === `attributes`;
              ...
              attributes: {
                compose: function (e, t, n) {
                  ...
                  for (var a in (n ||
                    (r = Object.keys(r).reduce(function (e, t) {
                      return (r[t] != null && (e[t] = r[t]), e);
                    }, {})),
                  e))
                    e[a] !== void 0 && t[a] === void 0 && (r[a] = e[a]);
                ...
                diff: function (e, t) {
                  ...
                  var n = Object.keys(e)
                    ...
                    .reduce(function (n, i) {
                      return (
                        r(e[i], t[i]) || (n[i] = t[i] === void 0 ? null : t[i]),
                        n
                      );
                    }, {});
          ...
          ((o.prototype.hasNext = function () {
            ...
            (o.prototype.next = function (e) {
              ...
              if (t) {
                ...
                if (
                  (e >= r - n
                    ? ((e = r - n), (this.index += 1), (this.offset = 0))
                    : (this.offset += e),
                ...
                var i = {};
                return (
                  t.attributes && (i.attributes = t.attributes),
                  typeof t.retain == `number`
                    ? (i.retain = e)
                    : typeof t.insert == `string`
                      ? (i.insert = t.insert.substr(n, e))
                      : (i.insert = t.insert),
                  i
                );
          ...
          var n = (function () {
            ...
            function i(a, o, s, c, u) {
              ...
              function m(a, s) {
                ...
                if (e(a, t)) h = new t();
                ...
                else if (i.__isArray(a)) h = [];
                else if (i.__isRegExp(a))
                  ((h = new RegExp(a.source, l(a))),
                    a.lastIndex && (h.lastIndex = a.lastIndex));
                else if (i.__isDate(a)) h = new Date(a.getTime());
                else if (p && Buffer.isBuffer(a))
                  return (
                  ...
                  e(a, Error)
                    ? (h = Object.create(a))
                    : c === void 0
                      ? ((g = Object.getPrototypeOf(a)), (h = Object.create(g)))
                      : ((h = Object.create(c)), (g = c));
                if (o) {
                  var _ = d.indexOf(a);
                  if (_ != -1) return f[_];
                  (d.push(a), f.push(h));
                ...
                a)) {
                  var y;
                  (g && (y = Object.getOwnPropertyDescriptor(g, v)),
                    !(y && y.set == null) && (h[v] = m(a[v], s - 1)));
                }
                if (Object.getOwnPropertySymbols)
                  for (
                    var b = Object.getOwnPropertySymbols(a), v = 0;
                    v < b.length;
                    v++
                  ) {
                    var x = b[v],
                      S = Object.getOwnPropertyDescriptor(a, x);
                    (S && !S.enumerable && !u) ||
                      ((h[x] = m(a[x], s - 1)),
                      S.enumerable ||
                        Object.defineProperty(h, x, { enumerable: !1 }));
                  }
                if (u)
                  for (
                    var C = Object.getOwnPropertyNames(a), v = 0;
                    v < C.length;
                    v++
                  ) {
                    var w = C[v],
                      S = Object.getOwnPropertyDescriptor(a, w);
                    (S && S.enumerable) ||
                      ((h[w] = m(a[w], s - 1)),
                      Object.defineProperty(h, w, { enumerable: !1 }));
                  }
                return h;
              }
              return m(a, s);
            ...
            i.__objToStr = a;
            function o(e) {
              return typeof e == `object` && a(e) === `[object Date]`;
            }
            i.__isDate = o;
            function s(e) {
              return typeof e == `object` && a(e) === `[object Array]`;
            }
            i.__isArray = s;
            function c(e) {
              return typeof e == `object` && a(e) === `[object RegExp]`;
            }
            i.__isRegExp = c;
            function l(e) {
              var t = ``;
            ...
            return ((i.__getRegExpFlags = l), i);
          })();
          typeof e == `object` && e.exports && (e.exports = n);
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = (function () {
            ...
            return (
              i(t, [
                ...
                },
                {
                  key: `deleteAt`,
                  value: function (e, n) {
                    var i = r(this.line(e), 2),
                      o = i[0],
                      s = i[1],
                      l = r(this.line(e + n), 1)[0];
                    if (
                      (a(
                        t.prototype.__proto__ ||
                          Object.getPrototypeOf(t.prototype),
                      ...
                      if (
                        o instanceof c.BlockEmbed ||
                        l instanceof c.BlockEmbed
                      ) {
                        this.optimize();
                        return;
                      }
                      if (o instanceof d.default) {
                        var f = o.newlineIndex(o.length(), !0);
                        if (f > -1 && ((o = o.split(f + 1)), o === l)) {
                          this.optimize();
                          return;
                        }
                      } else if (l instanceof d.default) {
                        var p = l.newlineIndex(0);
                        p > -1 && l.split(p + 1);
                      }
                      var m =
                        l.children.head instanceof u.default
                          ? null
                          : l.children.head;
                      (o.moveChildren(l, m), o.remove());
                    }
                    this.optimize();
                  },
                },
...
`) &&
                    ...
                    return (function e(t, n, r) {
                      ...
                      return (
                        t.children.forEachAt(n, r, function (t, n, r) {
                          (_(t)
                            ? i.push(t)
                            : t instanceof o.default.Container &&
                              (i = i.concat(e(t, n, a))),
                            (a -= r));
                        }),
                        i
          ...
          ((v.blotName = `scroll`),
            ...
            (v.allowedChildren = [l.default, c.BlockEmbed, f.default]),
            (t.default = v));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            S = (function (e) {
              ...
              function t(e, n) {
                ...
                return (
                  ...
                  r.addBinding({ key: t.keys.BACKSPACE }, { collapsed: !1 }, E),
                  r.addBinding({ key: t.keys.DELETE }, { collapsed: !1 }, E),
                  r.addBinding(
                    {
                      key: t.keys.BACKSPACE,
                      altKey: null,
                      ...
                      this.quill.root.addEventListener(`keydown`, function (n) {
                        if (!n.defaultPrevented) {
                          ...
                          if (o.length !== 0) {
                            ...
                            if (!(c == null || !e.quill.hasFocus())) {
                              var l = i(e.quill.getLine(c.index), 2),
                                u = l[0],
                                f = l[1],
                                p = i(e.quill.getLeaf(c.index), 2),
                                m = p[0],
                                h = p[1],
                                g = i(
                                  c.length === 0
                                    ? [m, h]
                                    : e.quill.getLeaf(c.index + c.length),
                                  2,
                                ),
                                _ = g[0],
                                v = g[1],
                                y =
                                  m instanceof d.default.Text
                                    ? m.value().slice(0, h)
                                    : ``,
                                b =
                                  _ instanceof d.default.Text
                                    ? _.value().slice(v)
                                    : ``,
                                x = {
                                  collapsed: c.length === 0,
                                  empty: c.length === 0 && u.length() <= 1,
                              ...
                              o.some(function (t) {
                                if (
                                  (t.collapsed != null &&
                                    t.collapsed !== x.collapsed) ||
                                  (t.empty != null && t.empty !== x.empty) ||
                                  (t.offset != null && t.offset !== x.offset)
                                )
                                  return !1;
                                if (Array.isArray(t.format)) {
                                  if (
                                    t.format.every(function (e) {
                                      return x.format[e] == null;
                                    })
                                  )
                                    return !1;
                                } else if (
                                  r(t.format) === `object` &&
                                  !Object.keys(t.format).every(function (e) {
                                    return t.format[e] === !0
                                      ? x.format[e] != null
                                      : t.format[e] === !1
                                        ? x.format[e] == null
                                ...
                                return (t.prefix != null &&
                                  !t.prefix.test(x.prefix)) ||
                                  (t.suffix != null && !t.suffix.test(x.suffix))
                                  ? !1
                                  : t.handler.call(e, c, x) !== !0;
                              }) && n.preventDefault();
                            }
                          }
                        }
            ...
            (S.DEFAULTS = {
              bindings: {
                ...
                tab: {
                  ...
                  handler: function (e) {
                    ...
                    var t = new l.default()
                      ...
                      .delete(e.length)
                      .insert(`	`);
                    (this.quill.updateContents(t, f.default.sources.USER),
                      this.quill.history.cutoff(),
                ...
                "checklist enter": {
                  ...
                  format: { list: `checked` },
                  handler: function (e) {
                    var t = i(this.quill.getLine(e.index), 2),
                      n = t[0],
                      r = t[1],
                      a = (0, c.default)({}, n.formats(), { list: `checked` }),
                      o = new l.default()
                        .retain(e.index)
                        .insert(
                          `
`,
                    ...
                    (this.quill.updateContents(o, f.default.sources.USER),
                      this.quill.setSelection(
                        e.index + 1,
                        f.default.sources.SILENT,
                      ),
                ...
                "header enter": {
                  ...
                  suffix: /^$/,
                  handler: function (e, t) {
                    var n = i(this.quill.getLine(e.index), 2),
                      r = n[0],
                      a = n[1],
                      o = new l.default()
                        .retain(e.index)
...
`,
                ...
                "list autofill": {
                  ...
                  handler: function (e, t) {
                    var n = t.prefix.length,
                      r = i(this.quill.getLine(e.index), 2),
                      a = r[0],
                      o = r[1];
                    if (o > n) return !0;
                    var s = void 0;
                ...
                "code exit": {
                  ...
                  handler: function (e) {
                    var t = i(this.quill.getLine(e.index), 2),
                      ...
                      r = t[1],
                      a = new l.default()
                        .retain(e.index + n.length() - r - 2)
                        .retain(1, { "code-block": null })
                        .delete(1);
                    this.quill.updateContents(a, f.default.sources.USER);
                  },
                },
                "embed left": C(S.keys.LEFT, !1),
                "embed left shift": C(S.keys.LEFT, !0),
                "embed right": C(S.keys.RIGHT, !1),
                "embed right shift": C(S.keys.RIGHT, !0),
              },
            }));
          function C(e, t) {
            var n,
              r = e === S.keys.LEFT ? `prefix` : `suffix`;
            return (
              ...
              g(n, `handler`, function (n) {
                var r = n.index;
                return (
                  e === S.keys.RIGHT && (r += n.length + 1),
                  i(this.quill.getLeaf(r), 1)[0] instanceof d.default.Embed
                    ? (e === S.keys.LEFT
                        ? t
                          ? this.quill.setSelection(
                              n.index - 1,
          ...
          function w(e, t) {
            if (!(e.index === 0 || this.quill.getLength() <= 1)) {
              var n = i(this.quill.getLine(e.index), 1)[0],
                r = {};
              if (t.offset === 0) {
                var a = i(this.quill.getLine(e.index - 1), 1)[0];
                if (a != null && a.length() > 1) {
                  var o = n.formats(),
                    s = this.quill.getFormat(e.index - 1, 1);
                  r = u.default.attributes.diff(o, s) || {};
                }
              }
              var c = /[\uD800-\uDBFF][\uDC00-\uDFFF]$/.test(t.prefix) ? 2 : 1;
              (this.quill.deleteText(e.index - c, c, f.default.sources.USER),
          ...
          function T(e, t) {
            ...
            if (!(e.index >= this.quill.getLength() - n)) {
              var r = {},
                a = 0,
                o = i(this.quill.getLine(e.index), 1)[0];
              if (t.offset >= o.length() - 1) {
                var s = i(this.quill.getLine(e.index + 1), 1)[0];
                if (s) {
                  var c = o.formats(),
                    l = this.quill.getFormat(e.index, 1);
                  ((r = u.default.attributes.diff(c, l) || {}),
                    (a = s.length()));
                }
              }
              (this.quill.deleteText(e.index, n, f.default.sources.USER),
                Object.keys(r).length > 0 &&
                  this.quill.formatLine(
                    e.index + a - 1,
                    n,
          ...
          function E(e) {
            ...
            if (t.length > 1) {
              ...
              n = u.default.attributes.diff(i, r) || {};
            }
            (this.quill.deleteText(e, f.default.sources.USER),
              Object.keys(n).length > 0 &&
                this.quill.formatLine(e.index, 1, n, f.default.sources.USER),
              this.quill.setSelection(e.index, f.default.sources.SILENT),
              this.quill.focus());
          }
          function D(e, t) {
            var n = this;
            ...
            var r = Object.keys(t.format).reduce(function (e, n) {
              return (
                d.default.query(n, d.default.Scope.BLOCK) &&
...
`,
              ...
              this.quill.setSelection(e.index + 1, f.default.sources.SILENT),
              this.quill.focus(),
              Object.keys(t.format).forEach(function (e) {
                r[e] ??
                  (Array.isArray(t.format[e]) ||
                    (e !== `link` &&
                      n.quill.format(e, t.format[e], f.default.sources.USER)));
              }));
          }
          function O(e) {
            return {
              ...
              handler: function (t) {
                var n = d.default.query(`code-block`),
                  r = t.index,
                  a = t.length,
                  o = i(this.quill.scroll.descendant(n, r), 2),
                  s = o[0],
                  c = o[1];
                if (s != null) {
                  var l = this.quill.getIndex(s),
                    u = s.newlineIndex(c, !0) + 1,
                    p = s.newlineIndex(l + c + a),
                    m = s.domNode.textContent.slice(u, p).split(`
`);
                  ((c = 0),
                    m.forEach(function (t, i) {
                      (e
                        ? (s.insertAt(u + c, n.TAB),
                          (c += n.TAB.length),
                          i === 0 ? (r += n.TAB.length) : (a += n.TAB.length))
                        : t.startsWith(n.TAB) &&
                          (s.deleteAt(u + c, n.TAB.length),
                          (c -= n.TAB.length),
                          i === 0 ? (r -= n.TAB.length) : (a -= n.TAB.length)),
                        (c += t.length + 1));
                    }),
                    this.quill.update(f.default.sources.USER),
                    this.quill.setSelection(r, a, f.default.sources.SILENT));
                }
              },
            };
          }
          function k(e) {
            return {
              ...
              handler: function (t, n) {
                this.quill.format(e, !n.format[e], f.default.sources.USER);
              },
            };
          }
          function A(e) {
            if (typeof e == `string` || typeof e == `number`)
              return A({ key: e });
            if (
              ((e === void 0 ? `undefined` : r(e)) === `object` &&
                (e = (0, o.default)(e, !1)),
              typeof e.key == `string`)
            )
              if (S.keys[e.key.toUpperCase()] != null)
                e.key = S.keys[e.key.toUpperCase()];
              else if (e.key.length === 1)
                e.key = e.key.toUpperCase().charCodeAt(0);
              else return null;
            return (e.shortKey && ((e[x] = e.shortKey), delete e.shortKey), e);
          }
          ((t.default = S), (t.SHORTKEY = x));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = (function () {
          ...
          var f = (function (e) {
            (d(t, e), a(t, null, [{ key: `value`, value: function () {} }]));
            function t(e, n) {
              l(this, t);
              var r = u(
                this,
                ...
                },
                {
                  ...
                  value: function (e, n) {
                    ...
                    r != null &&
                      ...
                      r.optimize(),
                      r.formatAt(a, t.CONTENTS.length, e, n),
                      (this._length = 0));
                  },
                },
                {
                  ...
                  value: function () {
                    if (!(this.selection.composing || this.parent == null)) {
                      var e = this.textNode,
                        ...
                        a = void 0,
                        c = void 0;
                      if (n != null && n.start.node === e && n.end.node === e) {
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (
                      e.some(function (e) {
                        return (
                          e.type === `characterData` && e.target === n.textNode
                        );
                      })
                    ) {
                      var r = this.restore();
        ...
        function (e, t, n) {
          ...
          ((u.allowedChildren = [a.default, i.BlockEmbed, u]), (t.default = u));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          var u = (function (e) {
            ...
            d = new a.default.Attributor.Class(`color`, `ql-color`, {
              scope: a.default.Scope.INLINE,
            }),
            f = new u(`color`, `color`, { scope: a.default.Scope.INLINE });
          ((t.ColorAttributor = u), (t.ColorClass = d), (t.ColorStyle = f));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              r(
                ...
                [
                  ...
                  },
                  {
                    key: `sanitize`,
                    value: function (e) {
                      return d(e, this.PROTOCOL_WHITELIST)
                        ? e
                        : this.SANITIZED_URL;
                    },
                  },
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      if (typeof Event == `function`)
                        ...
                        (typeof Event > `u` ? `undefined` : r(Event)) ===
                        `object`
                      ) {
        ...
        function (e, t, n) {
          ...
          t.default = (function () {
            function e(e) {
              ((this.domNode = e), (this.domNode[r.DATA_KEY] = { blot: this }));
            }
            return (
              ...
              (e.prototype.formatAt = function (e, t, n, i) {
                ...
                if (r.query(n, r.Scope.BLOT) != null && i) a.wrap(n, i);
              ...
              (e.prototype.insertAt = function (e, t, n) {
                var i = n == null ? r.create(`text`, t) : r.create(t, n),
                  a = this.split(e);
              ...
              (e.prototype.offset = function (e) {
                return (
                  e === void 0 && (e = this.parent),
                  this.parent == null || this == e
                    ? 0
              ...
              (e.prototype.replaceWith = function (e, t) {
                var n = typeof e == `string` ? r.create(e, t) : e;
          ...
          t.default = (function (e) {
            ...
            return (
              ...
              (t.prototype.remove = function (e) {
                (a(e, this.keyName).forEach(function (t) {
                  e.classList.remove(t);
                }),
                  e.classList.length === 0 && e.removeAttribute(`class`));
              }),
              (t.prototype.value = function (e) {
                var t = (a(e, this.keyName)[0] || ``).slice(
        ...
        function (e, t, n) {
          ...
          t.default = (function (e) {
            ...
            return (
              ...
              (t.prototype.add = function (e, t) {
                return this.canAdd(e, t)
                  ? ((e.style[a(this.keyName)] = t), !0)
                  : !1;
              }),
              (t.prototype.remove = function (e) {
                ((e.style[a(this.keyName)] = ``),
                  e.getAttribute(`style`) || e.removeAttribute(`style`));
              }),
              (t.prototype.value = function (e) {
                var t = e.style[a(this.keyName)];
                return this.canAdd(e, t) ? t : ``;
              }),
              t
            );
                    ...
                    if (e === this.leftGuard)
                      if (this.prev instanceof o.default) {
                        ...
                        ((n = document.createTextNode(r)),
                          this.parent.insertBefore(a.default.create(n), this),
                  ...
                  value: function (e, t) {
                    ...
                    e.forEach(function (e) {
                      if (
                        ...
                        (e.target === n.leftGuard || e.target === n.rightGuard)
                      ) {
        ...
        function (e, t, n) {
          ...
          var a = {
            ...
            o = new r.default.Attributor.Attribute(`align`, `align`, a),
            s = new r.default.Attributor.Class(`align`, `ql-align`, a),
            c = new r.default.Attributor.Style(`align`, `text-align`, a);
          ((t.AlignAttribute = o), (t.AlignClass = s), (t.AlignStyle = c));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          var o = new r.default.Attributor.Class(`background`, `ql-bg`, {
              scope: r.default.Scope.INLINE,
            }),
            s = new i.ColorAttributor(`background`, `background-color`, {
              scope: r.default.Scope.INLINE,
            });
          ((t.BackgroundClass = o), (t.BackgroundStyle = s));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.DirectionStyle =
          ...
          var a = { scope: r.default.Scope.BLOCK, whitelist: [`rtl`] },
            o = new r.default.Attributor.Attribute(`direction`, `dir`, a),
            s = new r.default.Attributor.Class(`direction`, `ql-direction`, a),
            c = new r.default.Attributor.Style(`direction`, `direction`, a);
          ((t.DirectionAttribute = o),
            (t.DirectionClass = s),
            (t.DirectionStyle = c));
        },
        function (e, t, n) {
          ...
          var u = {
            ...
            d = new a.default.Attributor.Class(`font`, `ql-font`, u);
          ((t.FontStyle = new ((function (e) {
            l(t, e);
            function t() {
              return (
                s(this, t),
        ...
        function (e, t, n) {
          ...
          var a = new r.default.Attributor.Class(`size`, `ql-size`, {
            ...
            o = new r.default.Attributor.Style(`size`, `font-size`, {
              scope: r.default.Scope.INLINE,
              whitelist: [`10px`, `18px`, `32px`],
            });
          ((t.SizeClass = a), (t.SizeStyle = o));
        },
        function (e, t, n) {
          e.exports = {
            ...
            function t(e, n) {
              ...
              return (
                ...
                r.quill.on(
                  ...
                  function (e, t, n, i) {
                    e !== a.default.events.TEXT_CHANGE ||
                      r.ignoreChange ||
                      (!r.options.userOnly || i === a.default.sources.USER
                        ? r.record(t, n)
                        : r.transform(t));
                  },
                ),
                  ...
                  value: function (e, t) {
                    if (this.stack[e].length !== 0) {
                      ...
                      (this.stack[t].push(n),
                        (this.lastRecorded = 0),
                        (this.ignoreChange = !0),
                        this.quill.updateContents(n[e], a.default.sources.USER),
                        (this.ignoreChange = !1));
                      var r = p(n[e]);
              ...
              : t.insert == null
                ? t.attributes == null
                  ...
                  : Object.keys(t.attributes).some(function (e) {
                      return i.default.query(e, i.default.Scope.BLOCK) != null;
                    })
                : typeof t.insert == `string` &&
                  t.insert.endsWith(`
`);
          ...
          function p(e) {
            var t = e.reduce(function (e, t) {
                return ((e += t.delete || 0), e);
              }, 0),
              n = e.length() - t;
            return (f(e) && --n, n);
          }
          ((t.default = d), (t.getLastChangeIndex = p));
        },
        function (e, t, n) {
          (Object.defineProperty(t, "__esModule", { value: !0 }),
                    ...
                    value: function (e, t) {
                      ...
                      ((this.pickers = e.map(function (e) {
                        if (e.classList.contains(`ql-align`))
                          return (
                            e.querySelector(`option`) ?? E(e, v),
                            new d.default(e, t.align)
                          );
                        if (
                          e.classList.contains(`ql-background`) ||
                          e.classList.contains(`ql-color`)
                        ) {
                          var n = e.classList.contains(`ql-background`)
                            ? `background`
                            : `color`;
                          return (
                            ...
                            e.querySelector(`option`) ??
                              (e.classList.contains(`ql-font`)
                                ...
                                : e.classList.contains(`ql-header`)
                                  ? E(e, x)
                                  : e.classList.contains(`ql-size`) && E(e, S)),
                            new f.default(e)
                          );
                      })),
                        this.quill.on(
          ...
          C.DEFAULTS = (0, a.default)(!0, {}, l.default.DEFAULTS, {
            modules: {
              toolbar: {
                handlers: {
                  formula: function () {
              ...
              r(t, [
                {
                  ...
                  value: function () {
                    ...
                    this.textbox.addEventListener(`keydown`, function (t) {
                      c.default.match(t, `enter`)
                        ? (e.save(), t.preventDefault())
                        : c.default.match(t, `escape`) &&
          ...
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.default = (function () {
              ...
              return (
                ...
                (e.prototype.offset = function (e) {
                  for (var t = 0, n = this.head; n != null;) {
                    if (n === e) return t;
                    ((t += n.length()), (n = n.next));
                  }
                  return -1;
                ...
                (e.prototype.forEachAt = function (e, t, n) {
                  if (!(t <= 0))
                    for (
                      ...
                      var l = o.length();
                      (e > s
                        ? n(o, e - s, Math.min(t, s + l - e))
                        : n(o, 0, Math.min(l, e + t - s)),
                        (s += l));
                    }
                }),
          ...
          t.default = (function (e) {
            ...
            function t(t) {
              ...
              return (
                ...
                n.observer.observe(n.domNode, o),
                n.attach(),
                n
              );
            }
                  ...
                  var c = function (e, t) {
                      (t === void 0 && (t = !0),
                        !(e == null || e === r) &&
                          ...
                          (e.domNode[a.DATA_KEY].mutations ??
                            (e.domNode[a.DATA_KEY].mutations = []),
                          t && c(e.parent)));
                    },
                    l = function (e) {
                      e.domNode[a.DATA_KEY] == null ||
                        e.domNode[a.DATA_KEY].mutations == null ||
                        (e instanceof i.default && e.children.forEach(l),
                        e.optimize(n));
                    },
                    u = t,
                    d = 0;
                ...
                (n === void 0 && (n = {}),
                  ...
                  t
                    .map(function (e) {
                      ...
                      return t == null
                        ? null
                        : t.domNode[a.DATA_KEY].mutations == null
                          ? ((t.domNode[a.DATA_KEY].mutations = [e]), t)
                          : (t.domNode[a.DATA_KEY].mutations.push(e), null);
                    })
                    .forEach(function (e) {
                      e == null ||
                        e === r ||
                        e.domNode[a.DATA_KEY] == null ||
                        e.update(e.domNode[a.DATA_KEY].mutations || [], n);
                    }),
            ...
            return (
              ...
              (t.prototype.format = function (n, r) {
                ...
                n === this.statics.blotName && !r
                  ? (this.children.forEach(function (e) {
                      (e instanceof i.default || (e = e.wrap(t.blotName, !0)),
                        a.attributes.copy(e));
                    }),
                    this.unwrap())
              ...
              (t.prototype.formatAt = function (t, n, r, i) {
                this.formats()[r] != null || a.query(r, a.Scope.ATTRIBUTE)
                  ? this.isolate(t, n).format(r, i)
                  : e.prototype.formatAt.call(this, t, n, r, i);
              }),
        ...
        function (e, t, n) {
          ...
          t.default = (function (e) {
            ...
            return (
              ...
              (t.prototype.format = function (n, r) {
                a.query(n, a.Scope.BLOCK) != null &&
                  (n === this.statics.blotName && !r
                    ? this.replaceWith(t.blotName)
                    : e.prototype.format.call(this, n, r));
              }),
              (t.prototype.formatAt = function (t, n, r, i) {
                a.query(r, a.Scope.BLOCK) == null
                  ? e.prototype.formatAt.call(this, t, n, r, i)
                  : this.format(r, i);
              }),
              (t.prototype.insertAt = function (t, n, r) {
                if (r == null || a.query(n, a.Scope.INLINE) != null)
          ...
          t.default = (function (e) {
            ...
            return (
              ...
              (t.prototype.insertAt = function (t, n, r) {
                r == null
                  ? ((this.text =
                      this.text.slice(0, t) + n + this.text.slice(t)),
                    (this.domNode.data = this.text))
                  : e.prototype.insertAt.call(this, t, n, r);
              }),
              (t.prototype.length = function () {
              ...
              (t.prototype.position = function (e, t) {
                return (t === void 0 && (t = !1), [this.domNode, e]);
              }),
              (t.prototype.split = function (e, t) {
                if ((t === void 0 && (t = !1), !t)) {
                  if (e === 0) return this;
              ...
              Object.defineProperty(Array.prototype, "find", {
                value: function (e) {
                  ...
                  for (
                    ...
                    if (((i = t[a]), e.call(r, i, a, t))) return i;
                },
              }),
        ...
        function (e, t) {
          ...
          function a(e, t, n) {
            ...
            var r = l(e, t),
              a = e.substring(0, r);
            ((e = e.substring(r)), (t = t.substring(r)), (r = u(e, t)));
          ...
          function s(e, t) {
            ...
            ((u[s + 1] = 0), (d[s + 1] = 0));
            for (
              var p = i - a, m = p % 2 != 0, h = 0, g = 0, _ = 0, v = 0, y = 0;
              y < o;
              y++
            ) {
                  ...
                  var w = s + E,
                    T =
                      E == -y || (E != y && d[w - 1] < d[w + 1])
                        ...
                        : d[w - 1] + 1,
                    D = T - E;
                  T < i && D < a && e.charAt(i - T - 1) == t.charAt(a - D - 1);
                )
                  (T++, D++);
                if (((d[w] = T), T > i)) v += 2;
                else if (D > a) _ += 2;
          ...
          function d(e, t) {
            ...
            function i(e, t, n) {
              for (
                ...
                var f = l(e.substring(n), t.substring(i)),
                  p = u(e.substring(0, n), t.substring(0, i));
                a.length < p + f &&
              ...
              return a.length * 2 >= e.length ? [o, s, c, d, a] : null;
            }
            ...
            var c, d, f, p;
            e.length > t.length
              ? ((c = s[0]), (d = s[1]), (f = s[2]), (p = s[3]))
              : ((f = s[0]), (p = s[1]), (c = s[2]), (d = s[3]));
            var m = s[4];
            return [c, d, f, p, m];
          }
          function f(e) {
            e.push([i, ``]);
            for (var t = 0, a = 0, o = 0, s = ``, c = ``, d; t < e.length;)
              switch (e[t][0]) {
                case r:
                  (o++, (c += e[t][1]), t++);
                  break;
                ...
                case i:
                  (a + o > 1
                    ? (a !== 0 &&
                        ...
                        ((d = l(c, s)),
                        d !== 0 &&
                          (t - a - o > 0 && e[t - a - o - 1][0] == i
                            ? (e[t - a - o - 1][1] += c.substring(0, d))
                            : (e.splice(0, 0, [i, c.substring(0, d)]), t++),
                          (c = c.substring(d)),
                          (s = s.substring(d))),
                        (d = u(c, s)),
                        d !== 0 &&
                          ((e[t][1] = c.substring(c.length - d) + e[t][1]),
                          (c = c.substring(0, c.length - d)),
                          (s = s.substring(0, s.length - d)))),
                      a === 0
                        ? e.splice(t - o, a + o, [r, c])
                        : o === 0
                          ? e.splice(t - a, a + o, [n, s])
                          : e.splice(t - a - o, a + o, [n, s], [r, c]),
                      (t = t - a - o + +!!a + +!!o + 1))
                    : t !== 0 && e[t - 1][0] == i
              ...
              (e[t - 1][0] == i &&
                ...
                e[t - 1][1]
                  ...
                  : e[t][1].substring(0, e[t + 1][1].length) == e[t + 1][1] &&
                    ((e[t - 1][1] += e[t + 1][1]),
                    (e[t][1] =
                      e[t][1].substring(e[t + 1][1].length) + e[t + 1][1]),
                    e.splice(t + 1, 1),
                    (p = !0))),
                t++);
            p && f(e);
          ...
          var p = a;
          ((p.INSERT = r), (p.DELETE = n), (p.EQUAL = i), (e.exports = p));
          function m(e, t) {
            if (t === 0) return [i, e];
          ...
          function h(e, t) {
            var n = m(e, t),
              ...
              o = r[a],
              s = r[a + 1];
            if (o == null || o[0] !== i) return e;
            if (s != null && o[1] + s[1] === s[1] + o[1])
              return (r.splice(a, 2, s, o), _(r, a, 2));
            if (s != null && s[1].indexOf(o[1]) === 0) {
              r.splice(a, 2, [s[0], o[1]], [0, o[1]]);
              var c = s[1].slice(o[1].length);
              return (
                c.length > 0 && r.splice(a + 2, 0, [s[0], c]),
                _(r, a, 3)
              );
            } else return e;
          }
          function g(e) {
            for (
              ...
              e[s - 2][0] === i &&
                ...
                a(e[s][1]) &&
                ((t = !0),
                (e[s - 1][1] = e[s - 2][1].slice(-1) + e[s - 1][1]),
                (e[s][1] = e[s - 2][1].slice(-1) + e[s][1]),
                (e[s - 2][1] = e[s - 2][1].slice(0, -1)));
            if (!t) return e;
            for (var c = [], s = 0; s < e.length; s += 1)
              e[s][1].length > 0 && c.push(e[s]);
            return c;
          }
          function _(e, t, n) {
        ...
        function (e, t) {
          ...
          ((o.prototype.eventNames = function () {
            ...
            (o.prototype.listeners = function (e, t) {
              ...
              if (!i) return [];
              if (i.fn) return [i.fn];
              for (var a = 0, o = i.length, s = Array(o); a < o; a++)
                s[a] = i[a].fn;
              return s;
            }),
        ...
        function (e, t, n) {
          ...
          var w = (0, u.default)(`quill:clipboard`),
            T = `__ql-matcher`,
            E = [
              [Node.TEXT_NODE, H],
              [Node.TEXT_NODE, B],
              ...
              [Node.ELEMENT_NODE, V],
              [Node.ELEMENT_NODE, I],
              [Node.ELEMENT_NODE, te],
              [`li`, ee],
              [`b`, F.bind(F, `bold`)],
              [`i`, F.bind(F, `italic`)],
              [`style`, z],
            ],
            D = [f.AlignAttribute, g.DirectionAttribute].reduce(function (
              e,
              t,
            ) {
                ...
                return (
                  ...
                  E.concat(r.options.matchers).forEach(function (e) {
                    var t = i(e, 2),
                      a = t[0],
                      o = t[1];
                    (!n.matchVisual && o === V) || r.addMatcher(a, o);
                  }),
                  r
                );
              }
                ...
                a(t, [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (t[m.default.blotName]) {
                        var n = this.container.innerText;
                        return (
                          (this.container.innerHTML = ``),
                          new s.default().insert(
                            n,
                            b({}, m.default.blotName, t[m.default.blotName]),
                          )
                        );
                      }
                      var r = i(this.prepareMatching(), 2),
                        a = r[0],
                        o = r[1],
                        c = P(this.container, a, o);
                      return (
                        M(
                          c,
                          `
`,
                          ...
                          c.ops[c.ops.length - 1].attributes == null &&
                          (c = c.compose(
                            new s.default().retain(c.length() - 1).delete(1),
                          )),
                        w.log(`convert`, this.container.innerHTML, c),
                        (this.container.innerHTML = ``),
                        c
                      );
                    },
                    ...
                    value: function (e, t) {
                      ...
                      if (typeof e == `string`)
                        ...
                        (this.quill.updateContents(
                          new s.default().retain(e).concat(r),
                          n,
                        ),
                          this.quill.setSelection(
                            e + r.length(),
                        ...
                        (this.container.focus(),
                          ...
                          setTimeout(function () {
                            ((r = r.concat(t.convert()).delete(n.length)),
                              ...
                              (t.quill.scrollingContainer.scrollTop = i),
                              t.quill.focus());
                          }, 1));
                      }
                    },
                      ...
                      return (
                        this.matchers.forEach(function (r) {
                          ...
                          switch (o) {
                            ...
                            default:
                              [].forEach.call(
                                e.container.querySelectorAll(o),
                                function (e) {
                                  ((e[T] = e[T] || []), e[T].push(s));
                                },
                              );
          ...
          function A(e, t, n) {
            return (t === void 0 ? `undefined` : r(t)) === `object`
              ...
              : e.reduce(function (e, r) {
                  return r.attributes && r.attributes[t]
                    ...
                    : e.insert(
                        r.insert,
                        (0, o.default)({}, b({}, t, n), r.attributes),
                      );
                }, new s.default());
          }
          function j(e) {
          ...
          function I(e, t) {
            var n = c.default.Attributor.Attribute.keys(e),
              r = c.default.Attributor.Class.keys(e),
              i = c.default.Attributor.Style.keys(e),
              a = {};
            return (
              n
                .concat(r)
                ...
                .forEach(function (t) {
                  ...
                  (n != null &&
                    ((a[n.attrName] = n.value(e)), a[n.attrName])) ||
                    ((n = D[t]),
                    n != null &&
                      (n.attrName === t || n.keyName === t) &&
                      (a[n.attrName] = n.value(e) || void 0),
                    (n = O[t]),
                    n != null &&
                      (n.attrName === t || n.keyName === t) &&
                      ((n = O[t]), (a[n.attrName] = n.value(e) || void 0)));
                }),
          ...
          function L(e, t) {
            ...
            if (n.prototype instanceof c.default.Embed) {
              ...
              typeof n.formats == `function` &&
                (t = A(t, n.blotName, n.formats(e)));
            return t;
          }
          function R(e, t) {
            return (
...
`,
              ...
              return t;
            for (
              var r = -1, i = e.parentNode;
              !i.classList.contains(`ql-clipboard`);
            )
              ((c.default.query(i) || {}).blotName === `list` && (r += 1),
                (i = i.parentNode));
            return r <= 0
              ? t
              : t.compose(
...
`,
                ...
                ((N(e) ||
                  (t.length() > 0 && e.nextSibling && N(e.nextSibling))) &&
                  t.insert(`
`)),
              t
            );
...
`,
              ...
              var n =
                e.offsetHeight +
                parseFloat(j(e).marginTop) +
                parseFloat(j(e).marginBottom);
              e.nextElementSibling.offsetTop > e.offsetTop + n * 1.5 &&
                t.insert(`
`);
            }
            return t;
          ...
          function te(e, t) {
            var n = {},
              r = e.style || {};
            return (
              r.fontStyle && j(e).fontStyle === `italic` && (n.italic = !0),
              r.fontWeight &&
                (j(e).fontWeight.startsWith(`bold`) ||
                  parseInt(j(e).fontWeight) >= 700) &&
                (n.bold = !0),
              Object.keys(n).length > 0 && (t = A(t, n)),
          ...
          function H(e, t) {
            var n = e.data;
            if (e.parentNode.tagName === `O:P`) return t.insert(n.trim());
            if (
              n.trim().length === 0 &&
            ...
            if (!j(e.parentNode).whiteSpace.startsWith(`pre`)) {
              ...
              ((n = n.replace(/\r\n/g, ` `).replace(/\n/g, ` `)),
                ...
                ((e.previousSibling == null && N(e.parentNode)) ||
                  (e.previousSibling != null && N(e.previousSibling))) &&
                  (n = n.replace(/^\s+/, r.bind(r, !1))),
                ((e.nextSibling == null && N(e.parentNode)) ||
                  (e.nextSibling != null && N(e.nextSibling))) &&
                  (n = n.replace(/\s+$/, r.bind(r, !1))));
            }
            return t.insert(n);
          }
        ...
        function (e, t, n) {
          ...
          var h = (0, c.default)(`quill:toolbar`),
            g = (function (e) {
              m(t, e);
              function t(e, n) {
                f(this, t);
                ...
                if (Array.isArray(i.options.container)) {
                  ...
                  (v(a, i.options.container),
                    e.container.parentNode.insertBefore(a, e.container),
                    (i.container = a));
                } else
                  typeof i.options.container == `string`
                ...
                return (
                  ...
                  i.quill.on(s.default.events.SCROLL_OPTIMIZE, function () {
                    var e = r(i.quill.selection.getRange(), 1)[0];
                    i.update(e);
                  }),
                  i
                );
              ...
              return (
                i(t, [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (n) {
                        ...
                        var i = e.tagName === `SELECT` ? `change` : `click`;
                        (e.addEventListener(i, function (i) {
                          var c = void 0;
                          if (e.tagName === `SELECT`) {
                            if (e.selectedIndex < 0) return;
                            var l = e.options[e.selectedIndex];
                            c = l.hasAttribute(`selected`) ? !1 : l.value || !1;
                          } else
                            ((c = e.classList.contains(`ql-active`)
                              ? !1
                              : e.value || !e.hasAttribute(`value`)),
                              i.preventDefault());
                          t.quill.focus();
                          var u = r(t.quill.selection.getRange(), 1)[0];
                          if (t.handlers[n] != null) t.handlers[n].call(t, c);
                          else if (
                            o.default.query(n).prototype instanceof
                            o.default.Embed
                          ) {
                            if (((c = prompt(`Enter ` + n)), !c)) return;
                          ...
                          } else t.quill.format(n, c, s.default.sources.USER);
                          t.update(u);
                        }),
                  ...
                  },
                  {
                    key: `update`,
                    value: function (e) {
                      var t = e == null ? {} : this.quill.getFormat(e);
                      this.controls.forEach(function (n) {
                        ...
                        if (o.tagName === `SELECT`) {
                          ...
                          s == null
                            ? ((o.value = ``), (o.selectedIndex = -1))
                            : (s.selected = !0);
                        } else if (e == null) o.classList.remove(`ql-active`);
                        else if (o.hasAttribute(`value`)) {
                          var l =
                            t[a] === o.getAttribute(`value`) ||
                            (t[a] != null &&
                              t[a].toString() === o.getAttribute(`value`)) ||
                            (t[a] == null && !o.getAttribute(`value`));
                          o.classList.toggle(`ql-active`, l);
                        } else o.classList.toggle(`ql-active`, t[a] != null);
                      });
                    },
                  },
                ]),
              ...
              t.forEach(function (t) {
                ...
                (n.classList.add(`ql-formats`),
                  t.forEach(function (e) {
                    if (typeof e == `string`) _(n, e);
                    else {
                      var t = Object.keys(e)[0],
                        r = e[t];
                      Array.isArray(r) ? y(n, t, r) : _(n, t, r);
                    }
                  }),
                  e.appendChild(n));
              }));
            ...
            handlers: {
                ...
                if (t != null)
                  if (t.length == 0) {
                    ...
                    Object.keys(n).forEach(function (t) {
                      o.default.query(t, o.default.Scope.INLINE) != null &&
                        e.quill.format(t, !1);
                    });
              ...
              indent: function (e) {
                ...
                if (e === `+1` || e === `-1`) {
                  var i = e === `+1` ? 1 : -1;
                  (n.direction === `rtl` && (i *= -1),
                    this.quill.format(`indent`, r + i, s.default.sources.USER));
                }
              },
              link: function (e) {
        ...
        function (e, t, n) {
          ...
          v.DEFAULTS = (0, o.default)(!0, {}, l.default.DEFAULTS, {
            modules: {
              toolbar: {
                handlers: {
                  link: function (e) {
                      ...
                      this.quill.on(
                        ...
                        function (t, n, i) {
                          if (t != null) {
                            if (
                              t.length === 0 &&
                              i === s.default.sources.USER
                            ) {
                              var a = r(
                                  e.quill.scroll.descendant(u.default, t.index),
                                  2,
                                ),
                                o = a[0],
                                c = a[1];
                              if (o != null) {
                                e.linkRange = new d.Range(
                                  t.index - c,
                                  o.length(),
                                );
                                var l = u.default.formats(o.domNode);
                                ((e.preview.textContent = l),
                                  e.preview.setAttribute(`href`, l),
                                  e.show(),
        ...
        function (e, t, n) {
                ...
                [
                  {
                    ...
                    value: function (e, n) {
                      e === m.blotName && !n
                        ? this.replaceWith(a.default.create(this.statics.scope))
                        : i(
                            t.prototype.__proto__ ||
                              Object.getPrototypeOf(t.prototype),
                            `format`,
            ...
            (f(t, e),
              r(t, null, [
                  ...
                  value: function (e) {
                    ...
                    return (
                      (e === `checked` || e === `unchecked`) &&
                        r.setAttribute(`data-checked`, e === `checked`),
                      r
                    );
                  },
                },
                {
                  key: `formats`,
                  value: function (e) {
                    if (e.tagName === `OL`) return `ordered`;
                    if (e.tagName === `UL`)
                      return e.hasAttribute(`data-checked`)
                        ? e.getAttribute(`data-checked`) === `true`
                          ? `checked`
                          : `unchecked`
                        : `bullet`;
                  },
                ...
                r = function (t) {
                  if (t.target.parentNode === e) {
                    ...
                    r === `checked`
                      ...
                      : r === `unchecked` && i.format(`list`, `checked`);
                  }
                };
              return (
          ...
          ((m.blotName = `list`),
            (m.scope = a.default.Scope.BLOCK_BLOT),
            (m.tagName = [`OL`, `UL`]),
        ...
        function (e, t, n) {
          ...
          ((c.blotName = `italic`), (c.tagName = [`EM`, `I`]), (t.default = c));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = (function () {
        ...
        function (e, t, n) {
          ...
          ((c.blotName = `strike`), (c.tagName = `S`), (t.default = c));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = i(n(6));
          ...
          ((c.blotName = `underline`), (c.tagName = `U`), (t.default = c));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = (function () {
                ...
                r(
                  ...
                  [
                    ...
                    },
                    {
                      key: `sanitize`,
                      value: function (e) {
                        return (0, o.sanitize)(e, [`http`, `https`, `data`])
                          ? e
                          : `//:0`;
                      },
                    },
        ...
        function (e, t, n) {
              ...
              r(t, [
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.cachedText !== t &&
                      ((t.trim().length > 0 || this.cachedText == null) &&
          ...
          var m = new a.default.Attributor.Class(`token`, `hljs`, {
              scope: a.default.Scope.INLINE,
            }),
            h = (function (e) {
              (f(t, e),
                r(t, null, [
                  {
                    key: `register`,
                    value: function () {
                      (o.default.register(m, !0), o.default.register(p, !0));
                    },
                  },
                ]));
              function t(e, n) {
                ...
                var i = null;
                return (
                  r.quill.on(o.default.events.SCROLL_OPTIMIZE, function () {
                    (clearTimeout(i),
                ...
                r(t, [
                  {
                    ...
                    value: function () {
                      ...
                      if (!this.quill.selection.composing) {
                        ...
                        var t = this.quill.getSelection();
                        (this.quill.scroll.descendants(p).forEach(function (t) {
        ...
        function (e, t, n) {
          ...
          g.DEFAULTS = (0, a.default)(!0, {}, c.default.DEFAULTS, {
            modules: {
              toolbar: {
                handlers: {
                  link: function (e) {
                  ...
                  function (e, t, n, i) {
                    if (e === o.default.events.SELECTION_CHANGE)
                      if (
                        ...
                        if (a.length === 1) r.position(r.quill.getBounds(t));
                        else {
                          var s = a[a.length - 1],
                            c = r.quill.getIndex(s),
                            u = Math.min(
                              s.length() - 1,
                              t.index + t.length - c,
                            ),
                            d = r.quill.getBounds(new l.Range(c, u));
                          r.position(d);
                        }
                      } else
              ...
              i(t, [
                        ...
                        function () {
                          setTimeout(function () {
                            if (!e.root.classList.contains(`ql-hidden`)) {
                              ...
                              t != null && e.position(e.quill.getBounds(t));
                            }
                          }, 1);
                        },
                      ));
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (((i.style.marginLeft = ``), n === 0)) return n;
      ...
      f = (function (e) {
        ...
        function t(t) {
          ...
          return (
            ...
            (n.selection = null),
            (n.onEditorChange = function (e, t, r, i) {
              var a, o, s, c;
              e === `text-change`
                ? (o = (a = n).onEditorChangeText) == null ||
                  o.call(a, n.editor.root.innerHTML, t, i, n.unprivilegedEditor)
                : e === `selection-change` &&
                  ((c = (s = n).onEditorChangeSelection) == null ||
                    c.call(s, t, i, n.unprivilegedEditor));
            }),
            (n.value = (n.isControlled() ? t.value : t.defaultValue) ?? ``),
            n
          );
        }
        return (
          (t.prototype.validateProps = function (e) {
            if (c.default.Children.count(e.children) > 1)
              throw Error(
                `The Quill editing area can only be composed of a single React element.`,
              );
            if (
              c.default.Children.count(e.children) &&
              c.default.Children.only(e.children)?.type === `textarea`
            )
              throw Error(
          ...
          (t.prototype.shouldComponentUpdate = function (e, t) {
            ...
            if (
              ...
              return !0;
            if (`value` in e) {
              var i = this.getEditorContents(),
                a = ((r = e.value), r ?? ``);
              this.isEqualValue(a, i) || this.setEditorContents(this.editor, a);
            }
            return (
              e.readOnly !== this.props.readOnly &&
                this.setEditorReadOnly(this.editor, e.readOnly),
              o(this.cleanProps, this.dirtyProps).some(function (t) {
                return !u.default(e[t], n.props[t]);
              })
            );
          }),
          (t.prototype.shouldComponentRegenerate = function (e) {
            ...
            return this.dirtyProps.some(function (n) {
              return !u.default(e[n], t.props[n]);
            });
          }),
          ...
          (t.prototype.componentDidUpdate = function (e, t) {
            ...
            if (this.editor && this.shouldComponentRegenerate(e)) {
              ...
              ((this.regenerationSnapshot = { delta: r, selection: i }),
                this.setState({ generation: this.state.generation + 1 }),
                this.destroyEditor());
            }
            if (this.state.generation !== t.generation) {
              var a = this.regenerationSnapshot,
                r = a.delta,
                o = a.selection;
              ...
              (s.setContents(r),
                p(function () {
                  return n.setEditorSelection(s, o);
                }));
            }
          }),
          ...
          (t.prototype.createEditor = function (e, t) {
            ...
            return (
              t.tabIndex != null && this.setEditorTabIndex(n, t.tabIndex),
              this.hookEditor(n),
              n
            );
          }),
          (t.prototype.hookEditor = function (e) {
            ((this.unprivilegedEditor = this.makeUnprivilegedEditor(e)),
              e.on(`editor-change`, this.onEditorChange));
          }),
          ...
          (t.prototype.setEditorSelection = function (e, t) {
            if (((this.selection = t), t)) {
              ...
              ((t.index = Math.max(0, Math.min(t.index, n - 1))),
                (t.length = Math.max(0, Math.min(t.length, n - 1 - t.index))),
                e.setSelection(t));
            }
          }),
          ...
          (t.prototype.getEditingArea = function () {
            if (!this.editingArea)
              throw Error(`Instantiating on missing editing area`);
            var e = l.default.findDOMNode(this.editingArea);
            if (!e) throw Error(`Cannot find element for editing area`);
            if (e.nodeType === 3)
              throw Error(`Editing area cannot be a text node`);
            return e;
          }),
          (t.prototype.renderEditingArea = function () {
            ...
            return c.default.Children.count(n)
              ? c.default.cloneElement(c.default.Children.only(n), i)
              : r
                ? c.default.createElement(`pre`, a({}, i))
                : c.default.createElement(`div`, a({}, i));
          }),
          (t.prototype.render = function () {
            ...
            return c.default.createElement(
              `div`,
              {
                ...
                key: this.state.generation,
                className: `quill ` + ((e = this.props.className), e ?? ``),
          ...
          (t.prototype.onEditorChangeText = function (e, t, n, r) {
            var i, a;
            if (this.editor) {
              var o = this.isDelta(this.value) ? r.getContents() : r.getHTML();
              o !== this.getEditorContents() &&
                ((this.lastDeltaChangeSet = t),
                (this.value = o),
                (a = (i = this.props).onChange) == null ||
                  a.call(i, e, t, n, r));
            }
          }),
          (t.prototype.onEditorChangeSelection = function (e, t, n) {
            ...
            if (this.editor) {
              ...
              u.default(e, l) ||
                ((this.selection = e),
                (i = (r = this.props).onChangeSelection) == null ||
                  i.call(r, e, t, n),
                d
                  ? (o = (a = this.props).onFocus) == null || o.call(a, e, t, n)
                  : f &&
                    ((c = (s = this.props).onBlur) == null ||
                      c.call(s, l, t, n)));
            }
          }),
  ...
  Ye = n((e) => {
    ...
    function c(e) {
      var t = Number(e),
        n;
      return ((t ||= ((n = e.match(/^(\d+)\s*\/\s*(\d+)$/)), n[1] / n[2])), t);
    }
    function l(e) {
      var t = parseFloat(e);
...
function tt(e) {
  ...
  var t = e.replace(Qe, et);
  return (J[e] = $e.test(t) ? `-` + t : t);
}
function nt(e, t) {
  if (e === t) return !0;
  if (!e || !t) return !1;
...
var Y = e(r()),
  X = Y.default.oneOfType([Y.default.string, Y.default.number]),
  Z = {
    all: Y.default.bool,
    grid: Y.default.bool,
    aural: Y.default.bool,
    braille: Y.default.bool,
    handheld: Y.default.bool,
    print: Y.default.bool,
    projection: Y.default.bool,
    screen: Y.default.bool,
    tty: Y.default.bool,
    tv: Y.default.bool,
    embossed: Y.default.bool,
  },
  rt = {
    orientation: Y.default.oneOf([`portrait`, `landscape`]),
    scan: Y.default.oneOf([`progressive`, `interlace`]),
    aspectRatio: Y.default.string,
    deviceAspectRatio: Y.default.string,
    height: X,
    deviceHeight: X,
    width: X,
    deviceWidth: X,
    color: Y.default.bool,
    colorIndex: Y.default.bool,
    monochrome: Y.default.bool,
    resolution: X,
    type: Object.keys(Z),
  },
  { type: it, ...at } = rt,
  Q = {
    minAspectRatio: Y.default.string,
    maxAspectRatio: Y.default.string,
    minDeviceAspectRatio: Y.default.string,
    maxDeviceAspectRatio: Y.default.string,
    minHeight: X,
    maxHeight: X,
    minDeviceHeight: X,
    maxDeviceHeight: X,
    ...
    minDeviceWidth: X,
    maxDeviceWidth: X,
    minColor: Y.default.number,
    maxColor: Y.default.number,
    minColorIndex: Y.default.number,
    maxColorIndex: Y.default.number,
    minMonochrome: Y.default.number,
    maxMonochrome: Y.default.number,
    minResolution: X,
    maxResolution: X,
    ...at,
  },
  ot = { all: { ...Z, ...Q }, types: Z, matchers: rt, features: Q },
  st = (e) => `not ${e}`,
  ct = (e, t) => {
    let n = tt(e);
    return (
  ...
  ut = (e) => {
    let t = [];
    return (
      Object.keys(ot.all).forEach((n) => {
        let r = e[n];
        r != null && t.push(ct(n, r));
      }),
      lt(t)
    );
  },
  dt = (0, q.createContext)(void 0),
  ft = (e) => e.query || ut(e),
  pt = (e) => {
    if (e) return Object.keys(e).reduce((t, n) => ((t[tt(n)] = e[n]), t), {});
  },
  $ = () => {
    let e = (0, q.useRef)(!1);
    return (
  ...
  _t = (e) => {
    let [t, n] = (0, q.useState)(e.matches);
    return (
      (0, q.useEffect)(() => {
        let t = (e) => {
          n(e.matches);
  ...
  vt = (e, t, n) => {
    let r = mt(t),
      i = ht(e);
    if (!i) throw Error(`Invalid or missing MediaQuery!`);
    let a = gt(i, r),
      o = _t(a),
      s = $();
    return (
  ...
  yt = ({ children: e, device: t, onChange: n, ...r }) => {
    let i = vt(r, t, n);
    return typeof e == `function` ? e(i) : i ? e : null;
  };
export { Je as n, yt as t };
