import { a as __toESM, n as require_react } from "./jsx-runtime-B5ErqjvK.js";
//#region node_modules/react-tag-input-component/dist/esm/index.js
...
function m({ text: e, remove: o, disabled: t, className: i }) {
	...
	return import_react.createElement("span", { className: d("rti--tag", i) }, import_react.createElement("span", null, e), !t && import_react.createElement("button", {
		type: "button",
		onClick: g,
		"aria-label": `remove ${e}`
	}, "✕"));
}
var S = ["Enter"], q = ({ name: e, placeHolder: o, value: t, onChange: i, onBlur: g, separators: l, disableBackspaceRemove: T, onExisting: v, onRemoved: y, disabled: h, isEditOnRemove: k, beforeAddValidate: x, onKeyUp: E, classNames: s }) => {
	...
	}, n.map((r) => import_react.createElement(m, {
		key: r,
		className: s == null ? void 0 : s.tag,
		text: r,
		remove: B,
		disabled: h
	})), import_react.createElement("input", {
		className: d("rti--input", s == null ? void 0 : s.input),
		type: "text",
		name: e,
		placeholder: o,
		onKeyDown: w,
