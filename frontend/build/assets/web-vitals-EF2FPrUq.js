var e,
  ...
  i = function (e, t) {
    return {
      ...
      delta: 0,
      entries: [],
      id: `v2-${Date.now()}-${Math.floor(8999999999999 * Math.random()) + 0xe8d4a51000}`,
    };
  },
  a = function (e, t) {
    try {
  ...
  c = function (e, t, n) {
    ...
    return function (i) {
      t.value >= 0 &&
        (i || n) &&
        ((t.delta = t.value - (r || 0)),
        (t.delta || r === void 0) && ((r = t.value), e(t)));
    };
  },
  l = -1,
  u = function () {
      ...
      f = function (e) {
        if (!e.hadRecentInput) {
          ...
          e.startTime - t.startTime < 5e3
            ? ((u += e.value), d.push(e))
            : ((u = e.value), (d = [e])),
            u > l.value && ((l.value = u), (l.entries = d), n()));
        }
      },
      g = a(`layout-shift`, f);
    g &&
      ((n = c(r, l, t)),
      o(function () {
        (g.takeRecords().map(f), n(!0));
      }),
      s(function () {
        ((u = 0), (h = -1), (l = i(`CLS`, 0)), (n = c(r, l, t)));
      }));
  },
  _ = { passive: !0, capture: !0 },
  v = new Date(),
  y = function (r, i) {
    e || ((e = i), (t = r), (n = new Date()), S(removeEventListener), b());
  },
  b = function () {
    if (t >= 0 && t < n - v) {
      var i = {
  ...
  x = function (e) {
    if (e.cancelable) {
      var t =
        (e.timeStamp > 0xe8d4a51000 ? new Date() : performance.now()) -
        e.timeStamp;
      e.type == `pointerdown`
        ? (function (e, t) {
            var n = function () {
  ...
  T = function (e, t) {
    var n,
      ...
      u = function (e) {
        var t = e.startTime;
        t < r.firstHiddenTime && ((l.value = t), l.entries.push(e), n());
      },
    ...
    if (d) {
      ...
      var p = function () {
        w[l.id] ||
          (d.takeRecords().map(u), d.disconnect(), (w[l.id] = !0), n(!0));
      };
      ([`keydown`, `click`].forEach(function (e) {
        ...
        s(function (r) {
          ((l = i(`LCP`)),
            ...
            requestAnimationFrame(function () {
              requestAnimationFrame(function () {
                ((l.value = performance.now() - r.timeStamp),
                  (w[l.id] = !0),
                  n(!0));
              });
            }));
...
export { g as getCLS, p as getFCP, C as getFID, T as getLCP, E as getTTFB };
