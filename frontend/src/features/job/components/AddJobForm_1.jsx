    ...
    <>
      <div className="container-fluid">
        <div className="container-sm">
          <h4 className="text-primary h3" style={{ marginTop: "20px" }}>
            ...
            <div className="col-lg-11">
              <div className="row items-start justify-start mb-3">
                ...
                <div className="col">
                  ...
                  />
                  {formError.title && (
                    <p className="text-danger text-sm">{formError.title}</p>
                  )}
                </div>
              </div>
              <div className="row mb-3">
                <div className="col-3">
                  <label htmlFor="basicTitle" className="text-[14px]">
                    Job basic title <sup className="text-danger">*</sup>
                  </label>
                </div>
                <div className="col">
                  <input
              ...
              <div className="row mb-3">
                <div className="col-3">
                  <label htmlFor="category" className="text-[14px]">
                    Job category <sup className="text-danger">*</sup>
                  </label>
                </div>
                <div className="col">
                  <select
                  ...
                  >
                    <option defaultValue="choose an option">
                      choose category
                    </option>
                  ...
                  {formError.category && (
                    <p className="text-danger text-sm">{formError.category}</p>
                  )}
                </div>
              </div>
              <div className="row mb-3">
                <div className="col-3">
                  <label htmlFor="subCategory" className="text-[14px]">
              ...
              <div className="row mb-3">
                <div className="col-3">
                  <label htmlFor="tags" className="text-[14px]">
                ...
                <div className="col">
                  ...
                  />
                  {formError.tags && (
                    <p className="text-danger text-sm">{formError.tags}</p>
                  )}
                </div>
              </div>
              <div className="row mb-3">
                <div className="col-3">
                  <label htmlFor="shortDescription" className="text-[14px]">
                    Job short description <sup className="text-danger">*</sup>
                  </label>
                </div>
