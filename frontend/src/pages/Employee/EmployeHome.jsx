    ...
    try {
      ...
      if (categoryNameList && categoryNameList.length > 0) {
        ...
        categoryNameList.forEach((categoryName) => {
          const foundCategory = sectionData.find(
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="col py-3">
                <h4 className="h4 text-prime capitalize">
                  Find Jobs According to Categories
                </h4>
              ...
              <div className="my-4">
                <h4 className="h4 text-prime capitalize my-4">
                  Find Jobs According to your profile
                </h4>
