      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
            ...
            <span className="text-[#2563EB]">Employers</span> and{" "}
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <ul className="space-y-4 p-0 list-none">
              <li className="flex gap-3 items-start text-sm md:text-base text-slate-600">
                ...
                <span>
                  We find talented professionals around the world (7 million and
                  counting).
                </span>
              </li>
              <li className="flex gap-3 items-start text-sm md:text-base text-slate-600">
                ...
                <span>
                  Empower them to prove their aptitude, abilities & attitude are
                  world-class.
                </span>
              </li>
              <li className="flex gap-3 items-start text-sm md:text-base text-slate-600">
                ...
                <span>
                  Enable companies to recruit the best 1% for premium remote
                  full-time jobs.
                </span>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/10 space-y-4">
              ...
              <p className="text-sm text-blue-50 leading-relaxed">
                It’s super hard to qualify—extreme quality standards ensure
                every single team member is at the top of their game.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/10 space-y-4">
              <div className="flex items-center gap-3 text-white">
              ...
              <p className="text-sm text-blue-50 leading-relaxed">
                Over 50% of new hires double or triple their previous pay. Why?
                Because that’s what the best person in the world is worth.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/10 space-y-4">
              <div className="flex items-center gap-3 text-white">
              ...
              <p className="text-sm text-blue-50 leading-relaxed">
                We don’t care where you went to school, what color your hair is,
                or whether we can pronounce your name. Just prove you’ve got the
                skills.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-slate-900">
              About Career Techguru
            </h2>
            <p className="text-slate-500 leading-relaxed text-sm md:text-base">
              Career Techguru is a job seeker and job advertising tool created
              by the developer team at ESPS Pvt Ltd. CTG uses web scraping
              technology to actively interact with third-party job posting
              websites and apply to many jobs.
            </p>
