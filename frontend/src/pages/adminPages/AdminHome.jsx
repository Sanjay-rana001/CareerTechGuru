  ...
  if (loading) {
    return (
      <div className="text-center p-10">
        <span className="text-xl">Loading Platform Data...</span>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={fetchCMSData} className="btn btn-primary">
          Refresh Data
        </button>
      </div>
              ...
              {users.map((u) => (
                <tr key={u.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${u.role === "superadmin" ? "bg-purple-100 text-purple-800" : u.role === "admin" ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800"}`}
                    >
