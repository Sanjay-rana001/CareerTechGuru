            ...
            <h3 className='h2 text-prime'>Enter new password</h3>
              <div className='bg-slate-100 p-2'>
                <div className="form-group mb-3">
                  <label htmlFor="newPassword" className="h6 mb-1">New Password <sup className="text-danger">*</sup></label>
                  <TextInput
                ...
                <div className="form-group mb-3">
                  <label htmlFor="confirmPassword" className="h6 mb-1">Confirm New Password <sup className="text-danger">*</sup></label>
                  <TextInput
                    type={passwordToggle ? "text" : "password"}
                    className="form-control"
