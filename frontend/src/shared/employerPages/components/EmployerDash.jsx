        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 border border-slate-200 rounded-2xl shadow-sm">
          <div>
            ...
            <p className="text-sm text-slate-400 mb-0">
              Overview of your jobs postings and candidates metrics
            </p>
          </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              ...
              <ul className="grid grid-cols-2 gap-x-4 gap-y-2 list-none p-0 text-xs">
                <li className="flex items-center gap-2">
                  ...
                  <b>Total Jobs Posted: {totalJobsPosted}</b>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#F59E0B] block"></span>{" "}
                  <b>Total Clicks: {totalClicks}</b>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#64748B] block"></span>{" "}
                  <b>Total Views: {totalViews}</b>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#EC4899] block"></span>{" "}
                  <b>Total Applicants: {totalApplicants}</b>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#10B981] block"></span>{" "}
                  <b>Selected: {totalSelectedApplicants}</b>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#EF4444] block"></span>{" "}
                  <b>Rejected: {totalRejectedApplicants}</b>
                </li>
              </ul>
            </div>
          </div>
