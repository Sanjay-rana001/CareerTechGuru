            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Alternate Number</label>
                                <input 
                                    type="number" 
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Experience (in years)</label>
                                <input 
                                    type="number" 
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Street</label>
                                <input 
                                    type="text" 
                                    name="address.street" 
                                    className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-colors" 
                        ...
                        <div className="flex items-center gap-2 pt-2">
                            ...
                            />
                            <label className="text-xs font-medium text-slate-500 cursor-pointer select-none" htmlFor="isPermanentAddress">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-6">
                        ...
                        {values.education.map((edu, index) => (
                            <div key={index} className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-4 relative">
                                <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Marks (GPA / Percentage)</label>
                                    <input
                                        type="text"
                                        name="marks"
                                        className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#2563EB]"
                                ...
                                <div className="flex items-center gap-2 pt-1">
                                    <input
                                        ...
                                        className="rounded border-slate-300 text-[#2563EB] focus:ring-[#2563EB]"
                                    />
                                    <label className="text-xs font-medium text-slate-500 cursor-pointer select-none" htmlFor={`edu-active-${index}`}>
                                        Currently pursuing
                                    </label>
                                </div>
                            </div>
                            ...
                            <div key={index} className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-4 relative">
                                ...
                                <div className="flex items-center gap-2 pt-1">
                                    <input
                                        ...
                                        className="rounded border-slate-300 text-[#2563EB] focus:ring-[#2563EB]"
                                    />
                                    <label className="text-xs font-medium text-slate-500 cursor-pointer select-none" htmlFor={`exp-active-${index}`}>
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Github</label>
                                <input 
                                    type="text" 
                                    name="links.github" 
                                    className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#2563EB]" 
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Twitter</label>
                                <input 
                                    type="text" 
                                    name="links.twitter" 
                                    className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#2563EB]" 
                            ...
                            <div className="flex flex-col gap-1.5 md:col-span-2">
                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Portfolio</label>
                                <input 
                                    type="text" 
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 space-y-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Preferred Category</label>
                            <Multiselect
                                options={sectionData}
                                ...
                                style={{
                                    ...
                                    searchBox: { border: '1px solid #CBD5E1', borderRadius: '8px', padding: '6px 12px' }
                                }}
                            />
                        </div>

                        <div className="flex flex-col gap-1.5">
                            <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Preferred Location</label>
                            <Multiselect
                                options={locations}
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Preferred Job Type</label>
                            <Multiselect
                                options={jobType}
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 space-y-4">
                            <span className="text-xs font-bold text-slate-700 block uppercase tracking-wider">Upload Resume</span>
                            <input
                                type="file"
                                name="file"
