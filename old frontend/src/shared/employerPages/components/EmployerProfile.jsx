                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-between items-center text-center md:text-left">
                        <div className="flex flex-col md:flex-row items-center gap-4">
                            <div className="w-16 h-16 bg-slate-50 rounded-xl border border-slate-100 p-1 flex items-center justify-center overflow-hidden flex-shrink-0">
                                {data?.profilePicture ? (
                                    <img src={data.profilePicture} alt="Logo" className="max-h-full max-w-full object-contain" />
                                ) : (
                                    <span className="text-xs text-slate-300 font-bold uppercase">CTG</span>
                                )}
                            </div>
                            <div className="space-y-1">
                                <h2 className="text-2xl font-bold text-slate-800 tracking-tight">{data?.companyName}</h2>
                                <p className="text-sm font-medium text-slate-500 mb-0 flex flex-wrap justify-center md:justify-start gap-2">
                                    <span className="flex items-center gap-1"><FaEnvelope className="text-slate-400" />{data?.companyEmail}</span>
                                    <span className="text-slate-350">|</span>
                                    <span className="flex items-center gap-1"><FaPhone className="text-slate-400" />{data?.companyContact}</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-sm font-semibold text-slate-700 capitalize">{data?.companyName}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-sm font-semibold text-slate-700 capitalize">{data?.numberOfEmployee}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-sm font-semibold text-slate-700">{data?.companyEmail}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-sm font-semibold text-slate-700 capitalize">{data?.companyContact}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="text-sm font-semibold text-slate-700">{data?.companyWebsite}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2 pt-1">
                                    {data?.service?.map((ser, idx) => (
                                        <span key={idx} className="px-3 py-1 bg-slate-100 rounded-lg text-xs font-semibold text-slate-600 border border-slate-200">
                                            {ser}
                                        </span>
                                    ))}
                                </div>
