...
const ProfileFormTwo = ({ prevStep, handleChange, handleSubmit }) => {
    ...
    const handleCountryChange = (e) => {
        const selectedCountry = countriesList.find(country => country.name === e.target.value);
    ...
    const handleCityChange = (e) => {
        const selectedCity = cityList?.find(state => state.name === e.target.value);
                    ...
                    <div className="row py-3">
                        <div className="col-lg-11">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col">
                                    <input type="text" name='pincode' onChange={handleChange('pincode')} className='form-input text-[14px] rounded-sm' placeholder='Enter pincode' />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3">
                                ...
                                <div className="col">
                                    <input type="text" name='companyAddress' onChange={handleChange('companyAddress')} className='form-input text-[14px] rounded-sm' placeholder='Enter company address' />
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-3">
                            ...
                            <div className="form-group flex items-center gap-3">
                                <button onClick={handleSubmit} className='btn bg-prime w-25 text-light'>Submit</button>
                                <button onClick={prevStep} className='btn btn-secondary text-light w-25'>Back</button>
                            </div>
                        </div>
                    </div>
                </div>
